...
void main() {
  ...
  test('ZvP 시나리오1: 히드라 압박 vs 포지더블 100경기', () async {
    ...
    final file = File('test/output/zvp/scenario1.md');
  ...
  test('ZvP 시나리오2: 뮤탈 운영 vs 포지더블 100경기', () async {
    ...
    final file = File('test/output/zvp/scenario2.md');
    file.writeAsStringSync(buffer.toString());
  ...
  test('ZvP 시나리오3: 9풀 vs 포지더블 100경기', () async {
    ...
    final file = File('test/output/zvp/scenario3.md');
    file.writeAsStringSync(buffer.toString());
  ...
  test('ZvP 시나리오4: 4풀 vs 전진 게이트 100경기', () async {
    ...
    final file = File('test/output/zvp/scenario4.md');
    file.writeAsStringSync(buffer.toString());
  ...
  test('ZvP 시나리오5: 뮤커지 vs 커세어 리버 100경기', () async {
    ...
    final file = File('test/output/zvp/scenario5.md');
    file.writeAsStringSync(buffer.toString());
