...
void main() {
  ...
  test('PvP S1: 원겟 드라군 넥서스 미러 100경기', () async {
    ...
    final file = File('test/output/pvp/s1_report.md');
  ...
  test('PvP S2: 원겟 드라군 vs 노겟 넥서스 100경기', () async {
    ...
    final file = File('test/output/pvp/s2_report.md');
    file.writeAsStringSync(buf.toString());
  ...
  test('PvP S3: 원겟 로보 리버 vs 투겟 드라군 100경기', () async {
    ...
    final file = File('test/output/pvp/s3_report.md');
    file.writeAsStringSync(buf.toString());
  ...
  test('PvP S4: 다크 올인 vs 스탠다드 100경기', () async {
    ...
    final file = File('test/output/pvp/s4_report.md');
    file.writeAsStringSync(buf.toString());
  ...
  test('PvP S5: 센터 게이트 질럿 러시 vs 스탠다드 100경기', () async {
    ...
    final file = File('test/output/pvp/s5_report.md');
    file.writeAsStringSync(buf.toString());
