...
void main() {
  ...
  test('PvT S1: 드라군 확장 vs 팩더블 100경기', () async {
    ...
    final file = File('test/output/pvt/s1_report.md');
  ...
  test('PvT S2: 리버 셔틀 vs 타이밍 러시 100경기', () async {
    ...
    final file = File('test/output/pvt/s2_report.md');
    file.writeAsStringSync(buf.toString());
  ...
  test('PvT S3: 다크 템플러 vs 스탠다드 100경기', () async {
    ...
    final file = File('test/output/pvt/s3_report.md');
    file.writeAsStringSync(buf.toString());
  ...
  test('PvT S4: 센터 게이트 질럿 러시 vs 스탠다드 100경기', () async {
    ...
    final file = File('test/output/pvt/s4_report.md');
    file.writeAsStringSync(buf.toString());
  ...
  test('PvT S5: 캐리어 vs 안티 캐리어 100경기', () async {
    ...
    final file = File('test/output/pvt/s5_report.md');
    file.writeAsStringSync(buf.toString());
  ...
  test('PvT S6: 5게이트 푸시 vs 팩더블 100경기', () async {
    ...
    final file = File('test/output/pvt/s6_report.md');
    file.writeAsStringSync(buf.toString());
