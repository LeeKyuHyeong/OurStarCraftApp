// TvT 100경기 상세 분석
// 실행: flutter test test/tvt_analysis_test.dart --reporter expanded
import 'dart:math';
...
void main() {
  test('TvT 100경기 상세 분석', () async {
    ...
    for (int i = 0; i < 100; i++) {
      ...
      final away = _makePlayer(name: 'Away', race: Race.terran, stats: _balancedStats);
    ...
    // ============================================================
    buf.writeln('╔══════════════════════════════════════════╗');
    buf.writeln('║   TvT 100경기 시뮬레이션 분석 보고서     ║');
    buf.writeln('╚══════════════════════════════════════════╝');
    buf.writeln('');
    ...
    // ============================================================
    final unitKeywords = [
      '마린', '벌처', '탱크', '시즈', '골리앗', '드랍십', '베슬', '레이스',
      '발키리', '배틀크루저', 'EMP', '마인', '벙커', 'SCV', '클로킹',
      'BBS', '서라운드',
    ];
