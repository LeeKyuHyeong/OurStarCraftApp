...
void main() {
  ...
  test('TvZ 시나리오 1: 바이오 러시 vs 뮤탈 100경기 → tvz_scenario1.md', () async {
    ...
    File('test/output/tvz/scenario1.md').writeAsStringSync(buf.toString());
    print('=== TvZ 시나리오 1 ===');
  ...
  test('TvZ 시나리오 2: 메카닉 vs 럴커 100경기 → tvz_scenario2.md', () async {
    ...
    File('test/output/tvz/scenario2.md').writeAsStringSync(buf.toString());
    print('=== TvZ 시나리오 2 ===');
    print('전적: T $homeWins - $awayWins Z');
  ...
  test('TvZ 시나리오 3: 벙커 치즈 vs 스탠다드 100경기 → tvz_scenario3.md', () async {
    ...
    File('test/output/tvz/scenario3.md').writeAsStringSync(buf.toString());
    print('=== TvZ 시나리오 3 ===');
    print('전적: T $homeWins - $awayWins Z');
  ...
  test('TvZ 시나리오 4: 111 vs 매크로 100경기 → tvz_scenario4.md', () async {
    ...
    File('test/output/tvz/scenario4.md').writeAsStringSync(buf.toString());
    print('=== TvZ 시나리오 4 ===');
    print('전적: T $homeWins - $awayWins Z');
  ...
  test('TvZ 시나리오 5: 레이스 vs 뮤탈 100경기 → tvz_scenario5.md', () async {
    ...
    File('test/output/tvz/scenario5.md').writeAsStringSync(buf.toString());
    print('=== TvZ 시나리오 5 ===');
    print('전적: T $homeWins - $awayWins Z');
  ...
  test('TvZ 시나리오 6: 벙커 vs 4풀 100경기 → tvz_scenario6.md', () async {
    ...
    File('test/output/tvz/scenario6.md').writeAsStringSync(buf.toString());
    print('=== TvZ 시나리오 6 ===');
    print('전적: T $homeWins - $awayWins Z');
  ...
  test('TvZ 시나리오 7: 스탠다드 vs 9풀 100경기 → tvz_scenario7.md', () async {
    ...
    File('test/output/tvz/scenario7.md').writeAsStringSync(buf.toString());
    print('=== TvZ 시나리오 7 ===');
    print('전적: T $homeWins - $awayWins Z');
