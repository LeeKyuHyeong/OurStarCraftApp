...
| **TvZ** | 208 | 208 | **0** | 100% |
| **ZvT** | 208 | 208 | **0** | 100% |
| **PvT/TvP** | 476 | 476 | **0** | 100% |
| **ZvP/PvZ** | 440 | 440 | **0** | 100% |
| **총합** | **1496** | **1513** | **17** | 99% |

### 미커버 상세

#### TvT: `tvt_fd_rush` 미커버 (17개)

`tvt_fd_rush`는 빌드만 등록된 상태 (시나리오 미생성). 상세 내용 확정 후 시나리오 추가 예정.
→ 전 빌드와 미러 포함 9개 시나리오 × 정방향/역방향 = 17개 미커버
