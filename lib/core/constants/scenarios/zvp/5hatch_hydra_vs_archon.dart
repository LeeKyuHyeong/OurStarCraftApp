    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeArmy: 0,
          homeResource: 0,
          awayArmy: 3, awayResource: -25,          altText: '{away}, 하이 템플러! 아콘으로 합체할까요?',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 6, homeResource: -30,          altText: '{home}, 히드라 대량 생산! 타이밍 공격!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -4, homeArmy: -2,              altText: '{home}, 히드라 집중 사격! 아콘이 무너집니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -6,              altText: '{away}, 스톰이 저그 병력을 녹여버립니다!',
            ),
            ScriptEvent(
