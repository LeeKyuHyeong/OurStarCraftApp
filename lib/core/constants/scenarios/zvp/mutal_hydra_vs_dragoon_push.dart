    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeArmy: 0,
          homeResource: 0,
          awayArmy: 4, awayResource: -20,          altText: '{away}, 드라군 행군! 저그 앞마당을 노립니다!',
        ),
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 2, homeResource: -15,          altText: '{home}, 성큰 건설! 드라군을 막아야 합니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayArmy: 0,
          homeResource: 0,
          homeArmy: 2, awayResource: -15,          altText: '{home}, 뮤탈 5기! 프로브를 견제합니다!',
        ),
        ScriptEvent(
          text: '{home}, 뮤탈이 프로브를 물어뜯습니다! 드라군이 돌아갑니다!',
          owner: LogOwner.home,
          homeArmy: 0,
          awayArmy: 0,
          homeResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 3,              altText: '{home}, 뮤탈 유인! 히드라가 전진합니다!',
            ),
            ScriptEvent(
              text: '{home}, 히드라와 뮤탈이 양방향에서 협공합니다!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
              awayResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeArmy: -4, homeResource: -15,              altText: '{away}, 드라군 화력! 앞마당이 무너집니다!',
            ),
            ScriptEvent(
              text: '{away}, 드라군이 본진까지 진입합니다! 해처리를 파괴!',
              owner: LogOwner.away,
              awayArmy: 0,
              awayResource: 0,
