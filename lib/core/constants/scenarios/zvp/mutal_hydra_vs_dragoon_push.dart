    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          altText: '{away}, 드라군 행군! 저그 앞마당을 노립니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{home}, 뮤탈 유인! 히드라가 전진합니다!',
            ),
            ScriptEvent(
              text: '{home}, 히드라와 뮤탈이 양방향에서 협공합니다!',
              owner: LogOwner.home,
              awayArmy: -5, favorsStat: 'attack',
              altText: '{home} 선수 양방향 공격! 드라군이 갈 곳이 없습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{away}, 드라군 화력! 앞마당이 무너집니다!',
            ),
            ScriptEvent(
