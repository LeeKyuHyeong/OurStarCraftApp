    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -5,
          altText: '{away} 선수, 프로브가 빠르게 이동합니다! 전진 건물?',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -25,
          altText: '{away} 선수, 전진 파일런에 게이트웨이! 앞에서 질럿을 뽑으려 합니다!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -30,
          altText: '{home} 선수, 앞마당 해처리! 매크로를 챙깁니다.',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: 4,          altText: '{away} 선수, 질럿 2기! 앞마당 해처리를 노립니다!',
        ),
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 2, homeResource: -10,          altText: '{home} 선수, 저글링과 드론 총동원! 앞마당을 지킵니다!',
        ),
        ScriptEvent(
          text: '{away} 선수, 질럿 추가 생산! 계속 압박합니다!',
          owner: LogOwner.away,
          homeArmy: 0,
          homeResource: 0,
        ...
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 2, homeResource: -15,          altText: '{home} 선수, 성큰이 올라갑니다! 질럿을 막아야 합니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          altText: '{home} 선수, 성큰 수비 성공! 히드라덴을 올립니다!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -30,
          altText: '{home} 선수, 해처리 추가! 물량을 준비합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 5, homeResource: -25,          altText: '{home} 선수, 히드라가 쏟아집니다! 업그레이드도 진행!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 4,              altText: '{home} 선수, 히드라 행군! 앞마당을 노립니다!',
            ),
            ScriptEvent(
              text: '{home} 선수, 히드라가 캐논과 질럿을 녹입니다! 물량이 압도적!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
              awayResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3, awayArmy: 2,              altText: '{away} 선수, 질럿이 앞마당 해처리를 부숩니다!',
            ),
            ScriptEvent(
              text: '{away} 선수, 질럿이 드론까지 추격합니다! 저그 자원이 바닥!',
              owner: LogOwner.away,
              homeArmy: 0,
              awayArmy: 0,
              awayResource: 0,
