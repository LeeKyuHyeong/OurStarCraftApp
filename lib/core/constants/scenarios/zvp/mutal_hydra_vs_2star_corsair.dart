    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 3, homeResource: -20,          altText: '{home}, 뮤탈 출격! 커세어와 맞붙습니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          owner: LogOwner.home,
          awayResource: 0,
          homeArmy: 2, awayArmy: -2, homeResource: -10,          altText: '{home}, 스커지 돌진! 커세어를 잡습니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -4,              altText: '{home}, 뮤탈과 스커지! 커세어가 전부 격추됩니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4,              altText: '{away}, 커세어 뉴트론 플레어! 뮤탈이 녹습니다!',
            ),
            ScriptEvent(
