    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -35,
          altText: '{away} 선수, 스타게이트 2개! 커세어 물량을 쏟아냅니다!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -25,
          altText: '{home} 선수, 가스 채취! 스파이어를 노립니다!',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          altText: '{home} 선수, 스파이어 완성! 뮤탈 생산 시작!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 3, homeResource: -20,          altText: '{home} 선수, 뮤탈 출격! 커세어와 맞붙습니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          altText: '{home} 선수, 히드라덴! 히드라가 커세어를 격추합니다!',
        ),
        ScriptEvent(
          text: '{home} 선수 스커지도 섞어서 커세어를 노립니다!',
          owner: LogOwner.home,
          awayResource: 0,
          homeArmy: 2, awayArmy: -2, homeResource: -10,          altText: '{home} 선수, 스커지 돌진! 커세어를 잡습니다!',
        ),
        ScriptEvent(
          ...
          altText: '{away} 선수, 드라군을 뽑습니다! 지상전 대비!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -4,              altText: '{home} 선수, 뮤탈과 스커지! 커세어가 전부 격추됩니다!',
            ),
            ScriptEvent(
              text: '{home} 선수, 뮤탈이 프로브를 견제합니다! 히드라가 지상을 밀어붙입니다!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4,              altText: '{away} 선수, 커세어 뉴트론 플레어! 뮤탈이 녹습니다!',
            ),
            ScriptEvent(
              text: '{away} 선수, 오버로드를 전멸시키고 드라군이 전진합니다!',
              owner: LogOwner.away,
              awayResource: 0,
              homeArmy: -2, homeResource: -10, awayArmy: 2,            ),
            ScriptEvent(
