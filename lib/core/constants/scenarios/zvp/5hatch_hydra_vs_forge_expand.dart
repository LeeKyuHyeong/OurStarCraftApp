    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeArmy: 0,
          homeResource: 0,
          awayArmy: 3, awayResource: -20,          altText: '{away}, 캐논 추가! 히드라를 막을 수 있을까요?',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 4, homeResource: -20,          altText: '{home}, 히드라가 쏟아집니다!',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          homeArmy: 5,          altText: '{home}, 히드라 행군! 캐논 라인을 노립니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -4,              altText: '{home}, 히드라 사격! 캐논이 녹아내립니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4,              altText: '{away}, 캐논 라인이 히드라를 저지합니다!',
            ),
            ScriptEvent(
