    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -15,
          altText: '{away} 선수, 포지를 올리고 앞마당 확장을 준비합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -30,
          altText: '{away} 선수, 넥서스와 캐논! 앞마당 방어를 준비합니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          altText: '{home} 선수, 히드라덴! 업그레이드를 서둡니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          homeArmy: 0,
          homeResource: 0,
          awayArmy: 3, awayResource: -20,          altText: '{away} 선수, 캐논 추가! 히드라를 막을 수 있을까요?',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -25,
          altText: '{away} 선수, 사이버네틱스 코어에서 스타게이트! 커세어로 오버로드를 사냥합니다!',
        ),
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 4, homeResource: -20,          altText: '{home} 선수, 히드라가 쏟아집니다!',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          homeArmy: 5,          altText: '{home} 선수, 히드라 행군! 캐논 라인을 노립니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          text: '{home} 선수, 히드라가 캐논 사정거리 밖에서 대기합니다! 업그레이드를 기다립니다!',
          owner: LogOwner.home,
          awayArmy: 0,
          homeResource: 0,
          awayResource: 0,
          homeArmy: 3,          altText: '{home} 선수 히드라 집결! 사업 완성을 기다립니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -4,              altText: '{home} 선수, 히드라 사격! 캐논이 녹아내립니다!',
            ),
            ScriptEvent(
              text: '{home} 선수, 히드라가 앞마당 넥서스까지 공격합니다!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4,              altText: '{away} 선수, 캐논 라인이 히드라를 저지합니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -5,              altText: '{away} 선수 스톰 투하! 저그 병력을 전멸시킵니다!',
            ),
            ScriptEvent(
              text: '{away} 선수, 드라군 질럿 한방 병력으로 역공합니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
