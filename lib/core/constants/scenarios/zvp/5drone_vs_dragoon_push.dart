    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          homeArmy: 1,          altText: '{home} 선수 저글링 도착! 질럿이 입구를 막고 있습니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayResource: -20, awayArmy: -2,              altText: '{home} 선수 프로브 전멸! 드라군 뒤를 파고들었습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -5, awayArmy: 3,              altText: '{away} 선수 역공! 드론이 없는 저그를 밀어냅니다!',
            ),
            ScriptEvent(
