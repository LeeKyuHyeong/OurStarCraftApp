    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeResource: -5,          altText: '{home}, 드론 동원! 프로브를 쫓아냅니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeArmy: 0,
          homeResource: 0,
          awayArmy: 3, awayResource: -20,          altText: '{away}, 추가 캐논! 저그 앞마당이 위험합니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -20,              altText: '{home}, 뮤탈이 프로브를 사냥합니다! 일꾼이 전멸해요!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -20, homeArmy: -2,              altText: '{away}, 캐논 화력! 해처리가 무너집니다!',
            ),
            ScriptEvent(
