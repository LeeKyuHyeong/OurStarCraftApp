    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -15,
          altText: '{away} 선수, 포지를 올리고 앞마당 확장을 노립니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -30,
          altText: '{away} 선수, 넥서스 건설! 캐논 라인으로 앞마당을 봉쇄합니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          altText: '{home} 선수, 스파이어 완성! 뮤탈리스크가 날아오릅니다!',
        ),
        ScriptEvent(
          text: '{home} 선수, 뮤탈이 프로토스 본진 프로브를 물어뜯습니다!',
          owner: LogOwner.home,
          homeArmy: 0,
          awayArmy: 0,
          homeResource: 0,
        ...
        ScriptEvent(
          ...
          altText: '{away} 선수, 사이버네틱스 코어 뒤로 스타게이트! 커세어로 뮤탈을 잡아야 합니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          homeArmy: 3,          altText: '{home} 선수, 뮤탈 유인! 히드라가 캐논 라인을 노립니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -25,
          altText: '{away} 선수, 템플러 아카이브! 스톰으로 히드라를 막아야 합니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -3,              altText: '{home} 선수, 뮤탈이 하이 템플러를 사냥합니다!',
            ),
            ScriptEvent(
              text: '{home} 선수, 히드라가 캐논 라인을 무너뜨립니다!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
              awayResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -5,              altText: '{away} 선수, 스톰! 히드라 편대가 녹아내립니다!',
            ),
            ScriptEvent(
              text: '{away} 선수, 커세어가 뮤탈을 쫓아냅니다! 질럿과 드라군이 역공합니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
