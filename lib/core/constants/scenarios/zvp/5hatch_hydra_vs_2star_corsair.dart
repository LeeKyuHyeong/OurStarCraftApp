    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          owner: LogOwner.away,
          awayResource: 0,
          awayArmy: 3, homeArmy: -1, homeResource: -15,          altText: '{away}, 커세어가 오버로드를 계속 격추합니다!',
        ),
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 2, homeResource: -20,          altText: '{home}, 히드라 사업 연구! 커세어를 아웃레인지합니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -4,              altText: '{home}, 히드라 사격! 커세어가 전멸합니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeArmy: -3, homeResource: -15,              altText: '{away}, 오버로드 전멸! 저그 보급이 끊깁니다!',
            ),
            ScriptEvent(
