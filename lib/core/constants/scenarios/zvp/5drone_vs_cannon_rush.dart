...
const _zvp5droneVsCannonRush = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -15,
          altText: '{home} 선수, 스포닝풀 건설 시작! 저글링 올인을 준비합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{home} 선수, 저글링 발업! 캐논이 완성되기 전에 잡아야 합니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -15,
          altText: '{away} 선수, 전진 캐논! 해처리 바로 앞에 올립니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          text: '{home} 선수, 저글링이 건설 중인 캐논으로 달려갑니다!',
          owner: LogOwner.home,
          awayArmy: 0,
          homeResource: 0,
          awayResource: 0,
        ...
        ScriptEvent(
          ...
          awayArmy: 0,
          homeResource: 0,
          homeArmy: -1, awayResource: -5,          altText: '{away} 선수, 프로브 방어! 캐논이 곧 완성됩니다!',
        ),
        ScriptEvent(
          ...
          awayResource: -10,        ),
        ScriptEvent(
          text: '{away} 선수, 두 번째 캐논도 건설하려 합니다!',
          owner: LogOwner.away,
          homeArmy: 0,
          awayArmy: 0,
          homeResource: 0,
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayArmy: 0,
          homeResource: 0,
          homeArmy: 2, awayResource: -10,          altText: '{home} 선수, 발업 저글링! 프로브를 잡으면서 캐논을 무시합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          text: '{home} 선수, 저글링이 프로토스 본진까지 진입합니다!',
          owner: LogOwner.home,
          homeArmy: 0,
          awayArmy: 0,
          homeResource: 0,
        ...
        ScriptEvent(
          text: '{away} 선수, 캐논을 저그 본진 근처에 추가로 올립니다!',
          owner: LogOwner.away,
          homeArmy: 0,
          homeResource: 0,
    ...
    ScriptPhase(
      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home} 선수, 저글링이 프로브를 전멸시키고 건물을 부수기 시작합니다!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away} 선수, 캐논이 해처리 근처까지 완성되면서 저그를 압박합니다!',
              owner: LogOwner.away,
              awayArmy: 0,
              awayResource: 0,
