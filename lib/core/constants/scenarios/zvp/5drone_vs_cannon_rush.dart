    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          owner: LogOwner.home,
          homeArmy: 2, awayResource: -10, favorsStat: 'control',
          altText: '{home}, 발업 저글링! 프로브를 잡으면서 캐논을 무시합니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{away} 선수 캐논 포위! 해처리가 캐논 사정거리 안!',
            ),
            ScriptEvent(
