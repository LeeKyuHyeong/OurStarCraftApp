...
const _zvp4poolVsProxyGate = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -15,
          altText: '{home} 선수, 스포닝풀 건설 시작! 극초반부터 공격적입니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -10,
          altText: '{away} 선수, 전진 파일런과 게이트웨이! 앞에서 질럿을 뽑으려 합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{away} 선수, 전진 게이트웨이에서 질럿 완성! 저그 본진을 향합니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          text: '{home} 선수, 저글링이 프로토스 본진에 도착! 프로브를 노립니다!',
          owner: LogOwner.home,
          homeArmy: 0,
          awayArmy: 0,
          homeResource: 0,
          awayResource: -10,          altText: '{home} 선수 저글링 진입! 일꾼을 공격합니다!',
        ),
        ScriptEvent(
          text: '{away} 선수, 질럿이 저그 본진에 도착합니다! 드론을 공격!',
          owner: LogOwner.away,
          homeArmy: 0,
          awayArmy: 0,
          awayResource: 0,
          homeResource: -10,          altText: '{away} 선수 질럿이 드론을 잡기 시작합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{home} 선수, 저글링이 추가 투입됩니다! 일꾼이 녹고 있어요!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          text: '{home} 선수, 저글링이 프로토스 프로브를 거의 다 잡았습니다!',
          owner: LogOwner.home,
          homeArmy: 0,
          awayArmy: 0,
          homeResource: 0,
          awayResource: -15,          altText: '{home} 선수 저글링이 일꾼을 거의 전멸시켰습니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{home} 선수, 저글링 보충! 수적 우위를 노립니다!',
        ),
      ],
    ),
    // Phase 3: 결전 (lines 30+)
    ScriptPhase(
      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home} 선수, 저글링이 넥서스를 파괴합니다! 프로토스 건물이 남지 않았습니다!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
              awayArmy: -3, awayResource: -20,              altText: '{home} 선수 넥서스 파괴! 전진 게이트웨이의 한계입니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away} 선수, 질럿이 해처리를 부수고 스포닝풀까지 공격합니다!',
              owner: LogOwner.away,
              awayArmy: 0,
              awayResource: 0,
              homeArmy: -3, homeResource: -20,              altText: '{away} 선수 해처리 파괴! 저그 건물이 무너집니다!',
            ),
            ScriptEvent(
