    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          altText: '{home} 선수 발업 저글링 진입! 프로브를 노립니다!',
        ),
        ScriptEvent(
          text: '{away}, 질럿이 저그 본진에 도착! 드론을 공격합니다!',
          owner: LogOwner.away,
          homeResource: -10, favorsStat: 'attack',
          altText: '{away} 선수 질럿 진입! 드론이 잡히기 시작합니다!',
        ),
        ScriptEvent(
          text: '{home} 선수 발업이 있어 프로브를 빠르게 잡습니다!',
          owner: LogOwner.home,
          awayResource: -10, homeArmy: 1, favorsStat: 'control',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          altText: '{home} 선수 저글링 보충! 건물을 부수기 시작합니다!',
        ),
        ScriptEvent(
