...
const _zvp5droneVsProxyGate = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -15,
          altText: '{home} 선수, 스포닝풀 건설! 빠른 저글링을 준비합니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -10,
          altText: '{away} 선수, 전진 파일런! 앞에서 게이트웨이를 올리려 합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{away} 선수, 전진 질럿 완성! 저그 본진을 향합니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          text: '{home} 선수, 발업 저글링이 프로토스 본진을 공격합니다!',
          owner: LogOwner.home,
          homeArmy: 0,
          awayArmy: 0,
          homeResource: 0,
        ...
        ScriptEvent(
          text: '{away} 선수, 질럿이 저그 본진에 도착! 드론을 공격합니다!',
          owner: LogOwner.away,
          homeArmy: 0,
          awayArmy: 0,
          awayResource: 0,
        ...
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -10,
          altText: '{away} 선수, 드론이 줄어듭니다! 질럿의 공격력이 높죠!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          text: '{home} 선수, 추가 저글링을 뽑아서 프로토스 건물을 공격합니다!',
          owner: LogOwner.home,
          awayArmy: 0,
          homeResource: 0,
        ...
        ScriptEvent(
          ...
          awayArmy: 0,
          homeResource: 0,
          awayResource: -10,          altText: '{home} 선수, 저글링이 일꾼을 추격합니다! 발업이라 도망칠 수 없어요!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home} 선수, 저글링이 넥서스를 파괴하고 게이트웨이까지 공격합니다!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away} 선수, 질럿이 해처리를 파괴하고 스포닝풀까지 부숩니다!',
              owner: LogOwner.away,
              awayArmy: 0,
              awayResource: 0,
