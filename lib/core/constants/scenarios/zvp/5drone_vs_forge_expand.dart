    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -20,
          altText: '{away} 선수, 포지 확장! 캐논으로 앞마당을 지키려 합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -15,
          altText: '{away} 선수, 캐논 건설을 서두릅니다! 빨리 완성해야 합니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayArmy: 0,
          homeResource: 0,
          homeArmy: -1, awayResource: -5,          altText: '{away} 선수, 프로브 방벽! 캐논까지 몇 초만 버텨야 합니다!',
        ),
        ScriptEvent(
          ...
          awayResource: -10,        ),
        ScriptEvent(
          text: '{away} 선수, 캐논 완성! 저글링을 잡기 시작합니다!',
          owner: LogOwner.away,
          homeResource: 0,
          awayResource: 0,
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          altText: '{away} 선수, 두 번째 캐논! 방어선이 넓어집니다!',
        ),
        ScriptEvent(
          text: '{home} 선수, 발업 저글링이 캐논 사이를 파고듭니다!',
          owner: LogOwner.home,
          homeArmy: 0,
          awayArmy: 0,
          homeResource: 0,
        ...
        ScriptEvent(
          text: '{away} 선수, 게이트웨이에서 질럿이 나오기 시작합니다!',
          owner: LogOwner.away,
          homeArmy: 0,
          homeResource: 0,
    ...
    ScriptPhase(
      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home} 선수, 저글링이 캐논을 파괴하고 넥서스를 공격합니다!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away} 선수, 캐논과 질럿으로 저글링을 전부 잡아냅니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
