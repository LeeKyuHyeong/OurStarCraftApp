    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayArmy: 0,
          homeResource: 0,
          awayResource: -10,          altText: '{home} 선수 저글링이 건설 중인 프로브를 노립니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 3, homeResource: -10,          altText: '{home} 선수 저글링 웨이브! 캐논을 집중 타격!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: -3, awayResource: -20,              altText: '{home} 선수 캐논 파괴! 프로토스 본진이 뚫립니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -5, awayArmy: 2,              altText: '{away} 선수 캐논 완성! 저글링이 녹습니다!',
            ),
            ScriptEvent(
