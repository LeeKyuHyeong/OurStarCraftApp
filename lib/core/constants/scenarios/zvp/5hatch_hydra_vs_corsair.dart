  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          text: '{away}, 커세어가 오버로드 2기를 격추합니다! 시야가 제한됩니다!',
          owner: LogOwner.away,
          awayArmy: 0,
          awayResource: 0,
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 4, homeResource: -20,          altText: '{home}, 히드라가 오버로드를 지킵니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 5, homeResource: -25,          altText: '{home}, 히드라가 쏟아집니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -25,
          altText: '{away}, 아둔에서 템플러 아카이브! 스톰 연구!',
        ),
      ],
    ),
    // Phase 3: 결전 (lines 30+)
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -3, homeArmy: 2,              altText: '{home}, 히드라 사격! 커세어가 떨어집니다!',
            ),
            ScriptEvent(
              text: '{home}, 히드라 물량이 프로토스 진지를 밀어붙입니다!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
              awayResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeArmy: -2, homeResource: -15,              altText: '{away}, 오버로드 전멸! 저그가 병력을 뽑을 수 없습니다!',
            ),
            ScriptEvent(
