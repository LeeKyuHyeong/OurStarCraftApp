    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          owner: LogOwner.away,
          awayResource: 0,
          awayArmy: 5, homeArmy: -1, homeResource: -15,          altText: '{away}, 캐논 완성! 해처리가 맞기 시작합니다!',
        ),
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 2, homeResource: -10,          altText: '{home}, 저글링 등장! 캐논 주변 프로브를 잡으러 갑니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeArmy: 0,
          awayResource: 0,
          awayArmy: 3, homeResource: -15,          altText: '{away}, 캐논 포격! 해처리 체력이 빠르게 줄어듭니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: -1,          altText: '{home}, 저글링! 캐논 주변 프로브를 노립니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 3, awayArmy: -4,              altText: '{home}, 히드라리스크 사거리로 캐논을 안전하게 처리합니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeArmy: -2, homeResource: -25,              altText: '{away}, 캐논 화력! 해처리가 무너집니다!',
            ),
            ScriptEvent(
