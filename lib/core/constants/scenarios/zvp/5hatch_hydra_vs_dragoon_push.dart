    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          altText: '{away} 선수, 2게이트! 질럿부터 뽑습니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeArmy: 0,
          homeResource: 0,
          awayArmy: 4, awayResource: -20,          altText: '{away} 선수, 드라군 행군! 앞마당을 노립니다!',
        ),
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 3, homeResource: -15,          altText: '{home} 선수, 저글링 방어! 성큰도 건설합니다!',
        ),
        ScriptEvent(
          text: '{away} 선수, 드라군 사정거리를 활용해 성큰을 노립니다!',
          owner: LogOwner.away,
          awayArmy: 0,
          homeResource: 0,
          awayResource: 0,
        ...
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -20,
          altText: '{home} 선수, 히드라덴! 히드라가 나오면 달라집니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          owner: LogOwner.home,
          awayResource: 0,
          homeArmy: 4, awayArmy: -2, homeResource: -20,          altText: '{home} 선수, 히드라 합류! 드라군과 정면 대결!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{away} 선수, 드라군 추가! 사정거리 싸움!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 3, awayArmy: -5,              altText: '{home} 선수, 히드라 물량! 드라군을 녹여버립니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: 2, homeArmy: -4,              altText: '{away} 선수, 드라군 마이크로! 히드라를 하나씩 잡습니다!',
            ),
            ScriptEvent(
