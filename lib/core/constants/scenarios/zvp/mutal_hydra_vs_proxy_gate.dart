    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -5,
          altText: '{away} 선수, 프로브가 이동합니다! 전진 건물인가요?',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -25,
          altText: '{away} 선수, 전진 게이트웨이! 질럿 러시를 준비합니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: 4,          altText: '{away} 선수, 질럿 도착! 앞마당 해처리를 노립니다!',
        ),
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 2, homeResource: -10,          altText: '{home} 선수, 저글링 방어! 드론까지 동원합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          text: '{away} 선수, 질럿을 추가 생산! 압박을 계속합니다!',
          owner: LogOwner.away,
          homeArmy: 0,
          homeResource: 0,
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -25,
          altText: '{home} 선수, 레어! 스파이어로 뮤탈을 준비합니다!',
        ),
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 4, homeResource: -25,          altText: '{home} 선수, 뮤탈리스크! 질럿 러시가 막혔으니 뮤탈로 견제!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{home} 선수, 히드라덴! 뮤탈과 히드라를 함께 운용합니다!',
        ),
      ],
    ),
    // Phase 3: 결전 (lines 30+)
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -15,              altText: '{home} 선수, 뮤탈이 프로브를 사냥합니다! 일꾼이 녹아요!',
            ),
            ScriptEvent(
              text: '{home} 선수, 히드라 편대가 전진합니다! 뮤탈과 동시 공격!',
              owner: LogOwner.home,
              homeResource: 0,
              awayResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeArmy: -3, homeResource: -20,              altText: '{away} 선수, 질럿이 해처리를 부숩니다! 앞마당 파괴!',
            ),
            ScriptEvent(
              text: '{away} 선수, 질럿이 드론까지 추격합니다!',
              owner: LogOwner.away,
              homeArmy: 0,
              awayArmy: 0,
              awayResource: 0,
