    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: 4,          altText: '{away}, 질럿 도착! 앞마당 해처리를 노립니다!',
        ),
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 2, homeResource: -10,          altText: '{home}, 저글링 방어! 드론까지 동원합니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 4, homeResource: -25,          altText: '{home}, 뮤탈리스크! 질럿 러시가 막혔으니 뮤탈로 견제!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -15,              altText: '{home}, 뮤탈이 프로브를 사냥합니다! 일꾼이 녹아요!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeArmy: -3, homeResource: -20,              altText: '{away}, 질럿이 해처리를 부숩니다! 앞마당 파괴!',
            ),
            ScriptEvent(
