  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          text: '{away} 선수도 게이트웨이 세 개! 양쪽 물량 경쟁!',
          owner: LogOwner.away,
          homeArmy: 0,
          awayArmy: 0,
          homeResource: 0,
        ...
        ScriptEvent(
          text: '양쪽 스피드질럿 물량! 게이트웨이 세 개씩 쏟아냅니다!',
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -20,              altText: '{home} 선수 질럿 견제! 프로브가 달아납니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -20,              altText: '{away} 선수 질럿 견제! 프로브가 달아납니다!',
            ),
            ScriptEvent(
