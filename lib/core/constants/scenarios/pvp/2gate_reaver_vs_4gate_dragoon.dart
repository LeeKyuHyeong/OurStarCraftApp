...
const _pvp2gateReaverVs4gateDragoon = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -30,
          altText: '{home} 선수, 게이트웨이가 두 개! 리버를 빠르게 준비합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{away} 선수, 게이트웨이 네 개! 드라군을 쏟아냅니다!',
        ),
        ScriptEvent(
          ...
          altText: '{home} 선수, 셔틀 리버! 드라군 호위와 함께!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          text: '{away} 선수, 드라군 대편대가 전진! 물량 타이밍!',
          owner: LogOwner.away,
          homeArmy: 0,
          homeResource: 0,
          awayResource: 0,
          awayArmy: 3,          altText: '{away} 선수 드라군 전진! 엄청난 물량!',
        ),
        ScriptEvent(
          text: '{home} 선수, 셔틀 리버에 드라군 호위! 맞받아칩니다!',
          owner: LogOwner.home,
          awayArmy: 0,
          homeResource: 0,
          awayResource: 0,
          homeArmy: 4,          altText: '{home} 선수 리버와 드라군으로 맞섭니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away} 선수, 드라군 물량이 셔틀을 집중 사격! 격추!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4, awayArmy: -2,              altText: '{away} 선수 셔틀 격추! 리버가 떨어집니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              text: '{away} 선수, 남은 드라군 물량으로 밀어냅니다!',
              owner: LogOwner.away,
              awayArmy: 0,
              homeResource: 0,
              awayResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home} 선수, 리버 스캐럽! 밀집한 드라군에 직격!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
              awayResource: 0,
              awayArmy: -6,              altText: '{home} 선수 스캐럽! 드라군이 한 번에!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              text: '{home} 선수, 드라군 호위와 리버 컨트롤! 반격!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
              awayResource: 0,
    ...
    ScriptPhase(
      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home} 선수, 스톰과 리버 화력! 드라군을 녹입니다!',
              owner: LogOwner.home,
              homeResource: 0,
              awayResource: 0,
              awayArmy: -10, homeArmy: -5,            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away} 선수, 스톰! 드라군 물량과 함께! 밀어냅니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
              homeArmy: -10, awayArmy: -5,            ),
            ScriptEvent(
