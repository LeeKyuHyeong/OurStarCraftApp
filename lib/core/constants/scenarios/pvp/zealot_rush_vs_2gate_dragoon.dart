    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          homeArmy: 2,          altText: '{home} 선수 질럿 러시! 상대 화력이 갖춰지기 전에!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayResource: -15, awayArmy: -1,              altText: '{home} 선수 질럿이 프로브를 베어냅니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -2, awayArmy: 3,              altText: '{away} 선수 드라군이 나옵니다! 질럿을 잡습니다!',
            ),
            ScriptEvent(
