    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          homeArmy: 2, awayArmy: 3,          altText: '{away} 선수 드라군 전진! 수가 엄청나게 많습니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4, awayArmy: -2,              altText: '{away} 선수 드라군 집중 사격! 셔틀이 위험합니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -6,              altText: '{home} 선수 스캐럽! 드라군이 한 번에 3기!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -10, homeArmy: -5,              altText: '{home} 선수 스톰과 스캐럽! 상대가 녹습니다!',
            ),
            ScriptEvent(
