...
const _pvp1gateRoboVs2gateDragoon = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          altText: '{away} 선수, 두 번째 게이트웨이! 드라군 물량으로 밀어붙이려는 의도!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -10,
          altText: '{home} 선수, 서포트 베이! 리버를 노립니다!',
        ),
        ScriptEvent(
          ...
          altText: '{away} 선수, 드라군 편대가 두꺼워지고 있습니다!',
        ),
        ScriptEvent(
          ...
          altText: '{home} 선수, 셔틀에 리버를 태울 준비를 합니다!',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          text: '{away} 선수, 드라군 편대가 전진합니다! 테크 전에 밀어야 합니다!',
          owner: LogOwner.away,
          homeArmy: 0,
          homeResource: 0,
          awayResource: 0,
        ...
        ScriptEvent(
          ...
          altText: '{home} 선수, 리버가 합류! 화력이 보강됩니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away} 선수, 드라군 물량이 상대 테크 전에 밀어냅니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home} 선수, 리버 스캐럽! 드라군 2기가 한 번에!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
              awayResource: 0,
            ...
            ScriptEvent(
              ...
              awayResource: 0,
              awayArmy: -3,
              altText: '{away} 선수, 상대 화력을 감당 못 합니다!',
            ),
            ScriptEvent(
              text: '{home} 선수, 셔틀 리버 컨트롤! 내렸다 태웠다! 완벽합니다!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
              awayResource: 0,
    ...
    ScriptPhase(
      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home} 선수, 스톰과 리버 화력! 드라군이 녹습니다!',
              owner: LogOwner.home,
              homeResource: 0,
              awayResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away} 선수, 맞스톰! 양쪽 병력이 동시에 소멸합니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
