    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 3, homeResource: -20,          altText: '{home} 선수 드라군 전진! 확장을 흔들어야 합니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: -3, awayResource: -10,              altText: '{home} 선수 드라군이 밀려옵니다! 수가 너무 많아요!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -5, awayArmy: -1,              altText: '{away} 선수 수비 성공! 드라군을 잡아냅니다!',
            ),
            ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeArmy: 0,
          homeResource: 0,
          awayArmy: 3, awayResource: 10,          altText: '{away} 선수 멀티 자원으로 압도합니다!',
        ),
        ScriptEvent(
