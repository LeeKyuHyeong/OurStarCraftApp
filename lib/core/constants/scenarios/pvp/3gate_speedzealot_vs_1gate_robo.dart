        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{home} 선수 질럿이 프로브에 도달! 수비가 안 돼요!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{home} 선수 스톰! 질럿이 남은 병력을 추격!',
            ),
            ScriptEvent(
              text: '스톰과 질럿의 조합! 결정적!',
              owner: LogOwner.home,
