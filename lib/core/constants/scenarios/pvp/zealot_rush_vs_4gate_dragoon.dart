...
const _pvpZealotRushVs4gateDragoon = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          altText: '{home} 선수, 질럿이 나옵니다! 드라군 물량이 나오기 전에 밀어야 합니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          text: '{home} 선수, 질럿 3기가 돌진합니다! 게이트웨이가 다 돌기 전에!',
          owner: LogOwner.home,
          awayArmy: 0,
          homeResource: 0,
          awayResource: 0,
          homeArmy: 2,          altText: '{home} 선수 질럿 러시! 드라군 물량이 나오기 전에 끝내야!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home} 선수, 질럿이 드라군을 잡고 프로브를 노립니다!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
              awayArmy: -1, awayResource: -15,              altText: '{home} 선수 질럿이 본진에 침투합니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              text: '{home} 선수, 추가 질럿 합류! 프로브를 학살합니다!',
              owner: LogOwner.home,
              awayArmy: 0,
              homeResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away} 선수, 드라군이 나오기 시작합니다! 질럿을 잡아냅니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3, awayArmy: 2,              altText: '{away} 선수 드라군으로 질럿을 저격합니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              text: '{away} 선수, 게이트웨이 네 개에서 드라군이 쏟아집니다! 압도적 물량!',
              owner: LogOwner.away,
              homeArmy: 0,
              homeResource: 0,
