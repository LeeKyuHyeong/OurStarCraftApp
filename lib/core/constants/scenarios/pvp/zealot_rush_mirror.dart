    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: 1,          altText: '{away} 선수 질럿이 맞섭니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -2, homeArmy: -1,              altText: '{home} 선수 질럿이 교전에서 앞섭니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -2, awayArmy: -1,              altText: '{away} 선수 질럿이 교전에서 앞섭니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -5, homeArmy: -2,              altText: '{home} 선수 드라군이 앞서갑니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -5, awayArmy: -2,              altText: '{away} 선수 드라군이 앞서갑니다!',
            ),
            ScriptEvent(
              text: '병력 차이가 벌어집니다! 결정적인 전진!',
              owner: LogOwner.away,
