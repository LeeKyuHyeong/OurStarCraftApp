...
const _pvpZealotRushVs1gateRobo = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -15,
          altText: '{home} 선수, 센터에 게이트웨이! 빠른 질럿!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{away} 선수, 서포트 베이! 리버를 준비합니다!',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          text: '{home} 선수, 질럿이 상대 진영으로 돌진합니다! 테크 전에 끝내야!',
          owner: LogOwner.home,
          awayArmy: 0,
          homeResource: 0,
          awayResource: 0,
          homeArmy: 1,          altText: '{home} 선수 질럿 러시! 프로브를 노립니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home} 선수, 질럿이 프로브를 잡습니다! 테크가 아직이에요!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
              awayResource: -20, awayArmy: -1,              altText: '{home} 선수 질럿이 프로브를 베어냅니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              text: '{home} 선수, 추가 질럿 합류! 로보틱스까지 위협합니다!',
              owner: LogOwner.home,
              awayArmy: 0,
              homeResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away} 선수, 질럿과 프로브로 버팁니다! 리버가 곧!',
              owner: LogOwner.away,
              awayArmy: 0,
              homeResource: 0,
              awayResource: 0,
              homeArmy: -1,              altText: '{away} 선수 수비! 리버만 나오면!',
            ),
            ScriptEvent(
              text: '{away} 선수, 리버가 나왔습니다! 스캐럽! 질럿이 터집니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
              homeArmy: -2, awayArmy: 2,              altText: '{away} 선수 리버 등장! 스캐럽 한 방에 질럿이!',
            ),
            ScriptEvent(
