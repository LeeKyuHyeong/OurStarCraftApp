    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 3, homeResource: -25,          altText: '{home} 선수 셔틀 리버! 드라군 호위까지!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -3,              altText: '{home} 선수 셔틀 리버 컨트롤이 한 수 위!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4,              altText: '{away} 선수 스캐럽 명중! 드라군이 터집니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3,              altText: '{away} 선수 셔틀 리버 컨트롤이 한 수 위!',
            ),
            ScriptEvent(
              text: '리버 컨트롤 차이가 결정적! 병력을 압도합니다!',
              owner: LogOwner.away,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -10, homeArmy: -5,              altText: '{home} 선수 스톰과 스캐럽! 상대 병력이 녹습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -10, awayArmy: -5,              altText: '{away} 선수 스톰과 스캐럽! 상대 병력이 녹습니다!',
            ),
            ScriptEvent(
              text: '스톰과 리버가 결정적! 전장을 지배합니다!',
              owner: LogOwner.away,
