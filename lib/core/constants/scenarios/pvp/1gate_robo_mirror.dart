...
const _pvp1gateRoboMirror = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -20,
          altText: '{home} 선수, 게이트웨이 후에 바로 로보틱스를 올리네요!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -20,
          altText: '{away} 선수, 로보틱스! 미러 매치가 되겠네요!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          text: '{home} 선수, 셔틀에 리버를 태웁니다! 프로브를 노립니다!',
          owner: LogOwner.home,
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 3, homeResource: -25,          altText: '{home} 선수 셔틀 리버 출격!',
        ),
        ScriptEvent(
          ...
          homeArmy: 0,
          homeResource: 0,
          awayArmy: 3, awayResource: -25,          altText: '{away} 선수, 셔틀 리버 출발! 양쪽 교차!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home} 선수, 리버가 프로브에 착지! 스캐럽!',
              owner: LogOwner.home,
              homeArmy: 0,
              awayArmy: 0,
              homeResource: 0,
              awayResource: -25,              altText: '{home} 선수 리버 투하! 프로브가 날아갑니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3,              altText: '{away} 선수, 셔틀 격추! 하지만 프로브 피해가!',
            ),
            ScriptEvent(
              text: '{home} 선수, 프로브 피해를 더 많이 줬습니다!',
              owner: LogOwner.home,
              awayArmy: 0,
              homeResource: 0,
              awayResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away} 선수, 리버가 프로브에 투하! 스캐럽 명중!',
              owner: LogOwner.away,
              homeArmy: 0,
              awayArmy: 0,
              awayResource: 0,
              homeResource: -25,              altText: '{away} 선수 리버 투하! 프로브를 쓸어냅니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -3,              altText: '{home} 선수, 셔틀을 잡았지만 프로브 피해가 크네요!',
            ),
            ScriptEvent(
              text: '{away} 선수, 프로브 피해를 더 입혔습니다! 자원 이점!',
              owner: LogOwner.away,
              homeArmy: 0,
              homeResource: 0,
              awayResource: 0,
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -20,
          altText: '{home} 선수, 아둔에 템플러 아카이브! 스톰을 노립니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home} 선수, 스톰! 드라군이 녹습니다!',
              owner: LogOwner.home,
              homeResource: 0,
              awayResource: 0,
              awayArmy: -8, homeArmy: -3,              altText: '{home} 선수 스톰 명중! 드라군 편대가 증발!',
              decisive: true,
            ),
          ],
        ),
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away} 선수, 스톰! 드라군이 녹습니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
              homeArmy: -8, awayArmy: -3,              altText: '{away} 선수 스톰 명중! 드라군 편대가 증발!',
              decisive: true,
            ),
          ],
        ),
