    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -20,
          altText: '{away} 선수, 배럭에 아카데미! 바이오닉 테크를 준비합니다.',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -30,
          altText: '{home} 선수, 사이버네틱스 코어 이후 넥서스 건설!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -20,
          altText: '{away} 선수, 팩토리가 올라갑니다! 마린과 탱크를 섞는 조합이군요.',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{away} 선수, 마린 메딕에 시즈 탱크까지! 강력한 조합이죠.',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: 3,          altText: '{away} 선수, 마린 탱크 부대가 이동합니다! 탱크 배치!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{away} 선수, 골리앗 생산! 마린 탱크 골리앗 풀조합!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -25,
          altText: '{home} 선수, 아둔에서 템플러 아카이브! 바이오닉엔 스톰이 답이죠.',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          altText: '{home} 선수, 게이트웨이 다섯 개에서 병력이 쏟아집니다! 하이 템플러도!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -25,
          altText: '{home} 선수, 아비터 트리뷰널이 올라갑니다! 리콜 준비!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{home} 선수, 아비터 등장 임박! 전세가 바뀔 수 있습니다.',
        ),
      ],
    ),
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -8, homeArmy: -1,              altText: '{home} 선수, 스톰 투하! 상대 병력이 순식간에 녹아내립니다!',
            ),
            ScriptEvent(
              text: '{home} 선수, 아비터 리콜! 탱크 라인 뒤로 병력 투하!',
              owner: LogOwner.home,
              homeResource: 0,
              awayResource: 0,
              homeArmy: 3, awayArmy: -3,              altText: '{home} 선수 리콜로 메카닉 후방을 급습합니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3,              altText: '{away} 선수, 골리앗 대공! 아비터가 위험합니다!',
            ),
            ScriptEvent(
              text: '{away} 선수, 마린이 스톰을 피하며 분산 이동! 탱크가 포격합니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
              awayArmy: 3, homeArmy: -5,              altText: '{away} 선수 마린 분산 컨트롤! 스톰 피해를 줄입니다!',
            ),
            ScriptEvent(
              text: '{away} 선수, 탱크 골리앗 마린 총공격! 삼위일체 화력!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
