    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -15,
          altText: '{away} 선수, 배럭이 두 개! 초반 러시를 노리는군요!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{away} 선수, 마린과 SCV 총출동! 배럭 두 개의 물량이 쏟아집니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{home} 선수, 필사적인 수비! 질럿과 프로브 동원!',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          homeArmy: 3, awayArmy: -4,          altText: '{home} 선수, 드라군 등장! 마린을 압도합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -30,
          altText: '{home} 선수, 수비 성공! 넥서스와 게이트웨이 추가!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -20,
          altText: '{home} 선수, 스타게이트가 올라갑니다! 캐리어를 노리는 건가요?',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -25,
          altText: '{home} 선수, 더블 스타게이트에 플릿 비콘! 캐리어 체제!',
        ),
        ScriptEvent(
          ...
          altText: '{away} 선수, 뒤늦게 골리앗 생산! 대공 준비가 되긴 할까요?',
        ),
        ScriptEvent(
          ...
          altText: '{home} 선수, 캐리어가 나옵니다! 인터셉터 충전 중!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 5, awayArmy: -5,              altText: '{home} 선수, 캐리어 3기! 인터셉터 비가 쏟아져 내립니다!',
            ),
            ScriptEvent(
              ...
              awayResource: 0,
              awayArmy: -4,
              altText: '{away} 선수, 골리앗이 너무 적습니다! 초반 올인의 후유증이네요!',
            ),
            ScriptEvent(
              text: '{home} 선수, 캐리어와 드라군 총공격! 테란을 밀어냅니다!',
              owner: LogOwner.home,
              homeResource: 0,
              awayResource: 0,
              awayArmy: -5, homeArmy: -1,            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: 4,              altText: '{away} 선수, 캐리어 전에 승부! 남은 병력으로 총공격!',
            ),
            ScriptEvent(
              text: '{away} 선수, 시즈 탱크 포격! 프로토스 방어선을 뚫습니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
              homeArmy: -5, awayArmy: -2,              altText: '{away} 선수 탱크 포격! 캐리어 나오기 전에 끝내야 합니다!',
            ),
            ScriptEvent(
