    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeArmy: 0,
          homeResource: 0,
          awayArmy: 4, awayResource: -25,          altText: '{away}, 탱크 라인이 촘촘합니다! 지상으로는 접근 불가!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 4, awayArmy: -5,              altText: '{home}, 캐리어 편대! 탱크 위에서 인터셉터가 쏟아집니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4,              altText: '{away}, 골리앗 집중 사격! 골리앗이 집중 사격! 적 함대가 위험합니다!',
            ),
            ScriptEvent(
