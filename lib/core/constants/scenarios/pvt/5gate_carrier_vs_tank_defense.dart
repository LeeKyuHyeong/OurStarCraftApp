    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -20,
          altText: '{away} 선수, 팩토리에 머신샵! 시즈 모드를 연구합니다.',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -30,
          altText: '{home} 선수, 넥서스가 올라갑니다! 확장을 가져가는군요.',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -30,
          altText: '{away} 선수, 커맨드센터에 벙커! 방어 위주 빌드입니다.',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeArmy: 0,
          homeResource: 0,
          awayArmy: 4, awayResource: -25,          altText: '{away} 선수, 탱크 라인이 촘촘합니다! 지상으로는 접근 불가!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -20,
          altText: '{home} 선수, 스타게이트 건설! 공중으로 우회하겠다는 판단!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -25,
          altText: '{home} 선수, 플릿 비콘이 올라갑니다! 캐리어 체제!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          altText: '{home} 선수, 더블 스타게이트! 캐리어가 연속으로 나옵니다!',
        ),
        ScriptEvent(
          ...
          altText: '{away} 선수, 골리앗 생산! 캐리어 대비를 급히 합니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 4, awayArmy: -5,              altText: '{home} 선수, 캐리어 편대! 탱크 위에서 인터셉터가 쏟아집니다!',
            ),
            ScriptEvent(
              ...
              altText: '{away} 선수, 골리앗이 캐리어를 잡으려 하지만 인터셉터가 너무 많아요!',
            ),
            ScriptEvent(
              text: '{home} 선수, 드라군도 합류! 지상과 공중 동시 공격!',
              owner: LogOwner.home,
              homeResource: 0,
              awayResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4,              altText: '{away} 선수, 골리앗 집중 사격! 골리앗이 집중 사격! 적 함대가 위험합니다!',
            ),
            ScriptEvent(
              text: '{away} 선수, 캐리어 1기 격추! 인터셉터도 쓸려 나갑니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
            ...
            ScriptEvent(
              text: '{away} 선수, 탱크 라인이 전진! 프로토스 앞마당을 포격합니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4, awayArmy: -1,              altText: '{away} 선수 탱크가 전진합니다! 시즈 포격으로 넥서스를 노립니다!',
            ),
            ScriptEvent(
