    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -20,
          altText: '{away} 선수, 배럭에서 팩토리! 빠른 테크입니다.',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -30,
          altText: '{home} 선수, 넥서스가 올라갑니다! 자원 확보가 우선이군요.',
        ),
        ScriptEvent(
          ...
          altText: '{away} 선수, 더블 팩토리! 타이밍 공격을 준비하는 모습!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: 4,          altText: '{away} 선수, 타이밍 공격 개시! 벌처 탱크가 밀려옵니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          homeArmy: 3, awayArmy: -2,          altText: '{home} 선수, 드라군 방어! 입구에서 교전합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: -2, homeArmy: -1,          altText: '{home} 선수, 질럿 우회! 탱크 뒤를 노리는 판단!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -25,
          altText: '{home} 선수, 아둔에 템플러 아카이브! 스톰 테크 준비!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -25,
          altText: '{home} 선수, 아비터 트리뷰널! 리콜 역습을 준비합니다!',
        ),
        ScriptEvent(
          ...
          altText: '{away} 선수, 병력을 다시 모으고 있습니다. 2차 공격 준비!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              homeArmy: 3, awayResource: -25,              altText: '{home} 선수, 아비터 리콜! 테란 본진에 병력 투하!',
            ),
            ScriptEvent(
              text: '{home} 선수, 스톰이 터집니다! 테란 병력이 녹아내리고 있어요!',
              owner: LogOwner.home,
              homeResource: 0,
              awayResource: 0,
              awayArmy: -8, homeArmy: -1,              altText: '{home} 선수 사이오닉 스톰! 상대 병력이 순식간에!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: 5,              altText: '{away} 선수, 지금이 기회! 아비터 전에 밀어야 합니다!',
            ),
            ScriptEvent(
              text: '{away} 선수, 시즈 탱크 포격! 프로토스 앞마당이 무너집니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
              homeArmy: -5, awayArmy: -2,              altText: '{away} 선수 시즈 포격! 프로토스 전선이 붕괴합니다!',
            ),
            ScriptEvent(
