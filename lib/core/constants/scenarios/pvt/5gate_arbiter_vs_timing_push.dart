    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: 4,          altText: '{away}, 타이밍 공격 개시! 벌처 탱크가 밀려옵니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          homeArmy: 3, awayArmy: -2,          altText: '{home}, 드라군 방어! 입구에서 교전합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: -2, homeArmy: -1,          altText: '{home}, 질럿 우회! 탱크 뒤를 노리는 판단!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              homeArmy: 3, awayResource: -25,              altText: '{home}, 아비터 리콜! 테란 본진에 병력 투하!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: 5,              altText: '{away}, 지금이 기회! 아비터 전에 밀어야 합니다!',
            ),
            ScriptEvent(
