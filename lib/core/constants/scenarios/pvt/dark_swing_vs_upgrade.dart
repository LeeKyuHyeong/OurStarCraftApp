    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -30,
          altText: '{away} 선수, 앞마당 확장! 자원을 빠르게 확보하려는 거군요!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -20,
          altText: '{home} 선수, 아둔! 다크를 노리고 있습니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -20,
          altText: '{home} 선수, 템플러 아카이브! 다크 준비 완료!',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeArmy: 3,
          homeResource: -15,
          altText: '{home} 선수, 다크 2기! 업그레이드 테란에 잠입합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          text: '{home} 선수, 다크가 은밀하게 접근합니다! 앞마당을 노립니다!',
          owner: LogOwner.home,
          homeArmy: 0,
          awayArmy: 0,
          homeResource: 0,
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          altText: '{away} 선수, 스캔 에너지가 부족합니다! 터렛을 올려야 할까요?',
        ),
        ScriptEvent(
          text: '{home} 선수, 다크 한 기가 앞마당, 한 기가 본진을 노립니다!',
          owner: LogOwner.home,
          homeArmy: 0,
          awayArmy: 0,
          homeResource: 0,
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              text: '{home} 선수, 양쪽에서 다크가 SCV를 베어냅니다! 막을 수 없어요!',
              owner: LogOwner.home,
              homeArmy: 0,
              awayArmy: 0,
              homeResource: 0,
            ...
            ScriptEvent(
              ...
              awayArmy: -15,
              decisive: true,
              altText: '{home} 선수, 다크 잠입 완벽! 업그레이드 테란의 약점을 찔렀습니다!',
            ),
          ],
        ),
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              altText: '{away} 선수, 터렛 배치! 다크를 포착합니다!',
            ),
            ScriptEvent(
              text: '{away} 선수, 마린이 다크를 집중 사격! 잡아냅니다!',
              owner: LogOwner.away,
              awayArmy: 0,
              homeResource: 0,
              awayResource: 0,
            ...
            ScriptEvent(
              ...
              awayArmy: 6,
              awayResource: -10,
              altText: '{away} 선수, 공방 업그레이드 마린! 화력이 크게 올랐습니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeArmy: -15,
              decisive: true,
              altText: '{away} 선수, 2-2 업그레이드 화력! 다크를 막고 역전!',
            ),
          ],
        ),
      ],
