    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -20,
          altText: '{away} 선수, 배럭에 아카데미! 바이오닉 체제!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -20,
          altText: '{away} 선수, 팩토리가 올라갑니다! 마린 탱크 골리앗 조합!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeArmy: 0,
          homeResource: 0,
          awayArmy: 4, awayResource: -20,          altText: '{away} 선수, 마린 탱크 골리앗 풀조합! 지상 공중 모두 커버!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -20,
          altText: '{home} 선수, 스타게이트! 캐리어를 노리는 건가요?',
        ),
        ScriptEvent(
          ...
          homeArmy: 0,
          awayResource: 0,
          awayArmy: 1, homeResource: -15,          altText: '{away} 선수, 드랍십 기습! 일꾼에 타격을 줍니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -25,
          altText: '{home} 선수, 플릿 비콘! 캐리어 테크 확정!',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          altText: '{home} 선수, 캐리어 생산 돌입! 인터셉터를 채웁니다!',
        ),
        ScriptEvent(
          ...
          altText: '{away} 선수, 골리앗이 늘어납니다! 캐리어 대비!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 5, awayArmy: -5,              altText: '{home} 선수, 캐리어 위에서, 드라군 아래에서! 이중 압박!',
            ),
            ScriptEvent(
              ...
              altText: '{away} 선수, 골리앗이 위를 보는 사이 지상이 뚫립니다!',
            ),
            ScriptEvent(
              text: '{home} 선수, 캐리어 인터셉터가 테란 일꾼을 날립니다!',
              owner: LogOwner.home,
              homeArmy: 0,
              awayArmy: 0,
              homeResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4,              altText: '{away} 선수, 골리앗 집중 사격! 골리앗이 집중 사격! 적 함대가 버티지 못합니다!',
            ),
            ScriptEvent(
              text: '{away} 선수, 탱크 시즈 포격으로 드라군도 정리합니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4, awayArmy: -1,            ),
            ScriptEvent(
              text: '{away} 선수, 마린 메딕이 프로토스 진영으로 돌입! 잔여 병력 정리!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3, awayArmy: -2,              altText: '{away} 선수 마린 메딕 돌격! 프로토스를 밀어냅니다!',
            ),
            ScriptEvent(
