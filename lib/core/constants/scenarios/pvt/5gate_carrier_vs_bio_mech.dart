    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeArmy: 0,
          homeResource: 0,
          awayArmy: 4, awayResource: -20,          altText: '{away}, 마린 탱크 골리앗 풀조합! 지상 공중 모두 커버!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          homeArmy: 0,
          awayResource: 0,
          awayArmy: 1, homeResource: -15,          altText: '{away}, 드랍십 기습! 일꾼에 타격을 줍니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 5, awayArmy: -5,              altText: '{home}, 캐리어 위에서, 드라군 아래에서! 이중 압박!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4,              altText: '{away}, 골리앗 집중 사격! 골리앗이 집중 사격! 적 함대가 버티지 못합니다!',
            ),
            ScriptEvent(
