    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -20,
          altText: '{home} 선수, 게이트웨이에 사이버네틱스 코어!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -15,
          altText: '{away} 선수, 아머리 건설! 골리앗 체제로 가는 겁니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayArmy: 3,
          awayResource: -15,
          altText: '{away} 선수, 골리앗 합류! 대공뿐 아니라 지상에서도 쓸만합니다!',
        ),
        ScriptEvent(
          ...
          homeArmy: 3,
          homeResource: -20,
          altText: '{home} 선수, 게이트웨이 다섯 개 가동! 공중 유닛 대신 지상 물량으로 갑니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          altText: '{home} 선수, 전군 전진! 공중 없이 지상으로만 밀어붙입니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -30,
          altText: '{away} 선수, 확장! 골리앗 추가 생산을 위한 자원 확보!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeArmy: 4,
              awayArmy: -4,
              altText: '{home} 선수, 질럿이 골리앗에 달라붙습니다! 근접에서 질럿이 강합니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 4,
              homeArmy: -4,
              altText: '{away} 선수, 골리앗이 탱크와 합동 사격! 상대 병력이 녹습니다!',
            ),
            ScriptEvent(
