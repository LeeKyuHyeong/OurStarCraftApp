    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          altText: '{away}, 골리앗 물량! 사거리 업그레이드까지 올립니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              owner: LogOwner.home,
              awayArmy: -6, homeArmy: -2, favorsStat: 'strategy',
              altText: '{home} 선수 스톰에 드라군 총공격! 남은 병력을 정리합니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{away}, 골리앗 대공! 아비터가 접근도 못합니다!',
            ),
            ScriptEvent(
