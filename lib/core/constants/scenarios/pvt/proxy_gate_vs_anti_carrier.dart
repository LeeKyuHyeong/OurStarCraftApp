    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -20,
          altText: '{away} 선수, 팩토리 아머리! 골리앗을 준비하는 빌드!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayResource: 0,
          homeArmy: 1,
          altText: '{home} 선수, 질럿 돌진! 골리앗 나오기 전에 끝내야 합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          text: '{home} 선수, 질럿이 마린을 밀어내고 SCV를 공격합니다!',
          owner: LogOwner.home,
          homeArmy: 0,
          homeResource: 0,
          awayResource: -15,
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -10,
          altText: '{away} 선수, 긴급 벙커! 질럿을 막아야 합니다!',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayArmy: 2,
          awayResource: -5,
          altText: '{away} 선수, 마린이 벙커에 들어갑니다!',
        ),
        ScriptEvent(
          text: '{home} 선수, 질럿이 벙커를 공격합니다! SCV 수리가 간당간당!',
          owner: LogOwner.home,
          homeArmy: 0,
          awayArmy: 0,
          homeResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayResource: 0,
              awayArmy: -3,
              altText: '{home} 선수, 벙커 파괴! 질럿이 밀려들어갑니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: -15,
              decisive: true,
              altText: '{home} 선수, 질럿이 테란 본진을 초토화합니다!',
            ),
          ],
        ),
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeArmy: -3,
              awayArmy: 3,
              altText: '{away} 선수, 벙커 방어 성공! 질럿 손실!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              text: '{away} 선수, 골리앗이 나옵니다! 지상 화력이 강력합니다!',
              owner: LogOwner.away,
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 5,
            ...
            ScriptEvent(
              ...
              homeArmy: -15,
              decisive: true,
              altText: '{away} 선수, 골리앗이 프로토스 진영까지 밀어붙입니다!',
            ),
          ],
        ),
      ],
