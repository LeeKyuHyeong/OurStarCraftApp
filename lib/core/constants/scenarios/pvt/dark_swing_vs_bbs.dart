    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          owner: LogOwner.away,
          awayResource: -20,
          altText: '{away}, 더블 배럭! 마린 올인을 노립니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          text: 'BBS 타이밍! 다크 템플러가 나오기 전에 끝낼 수 있을까요?',
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayArmy: 2,
          favorsStat: 'attack',
          altText: '{away}, BBS 전진! 마린과 SCV가 돌격합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          homeArmy: 2,
          homeResource: -10,
          altText: '{home} 선수 드라군 합류! BBS를 막아내려 합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          text: '프로토스가 BBS를 막아내면 다크가 나올 시간!',
          owner: LogOwner.system,
          skipChance: 0.2,
        ),
      ],
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeArmy: 3,
          homeResource: -15,
          altText: '{home}, 다크 템플러가 나옵니다! BBS에 디텍이 있을까요?',
        ),
        ScriptEvent(
          text: 'BBS는 가스가 없어서 디텍이 없을 확률이 높습니다!',
          owner: LogOwner.system,
        ),
      ],
    ),
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              owner: LogOwner.home,
              favorsStat: 'harass',
              altText: '{home}, 다크가 본진으로! BBS에 디텍이 없습니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              text: 'BBS의 약점! 가스가 없어서 디텍이 전혀 없습니다!',
              owner: LogOwner.system,
            ),
            ScriptEvent(
              text: '{home} 선수 다크 템플러가 SCV를 전멸시킵니다! BBS 역전 성공!',
              owner: LogOwner.home,
              homeArmy: 20,
              awayArmy: -15,
              decisive: true,
              altText: '{home}, 다크 역전! BBS가 디텍 없이 무너집니다!',
            ),
          ],
        ),
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              text: 'BBS 타이밍이 다크보다 빠릅니다! 프로토스가 견딜 수 없어요!',
              owner: LogOwner.system,
            ),
            ScriptEvent(
              text: '{away} 선수 BBS 마린 러시 성공! 프로토스가 GG!',
              owner: LogOwner.away,
              awayArmy: 20,
              homeArmy: -15,
              decisive: true,
              altText: '{away}, 다크 나오기 전에 끝! BBS 타이밍 완승!',
            ),
          ],
        ),
      ],
