    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -15,
          altText: '{home} 선수, 숨겨진 게이트웨이! 들키지 않았습니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -15,
          altText: '{away} 선수, 가스 팩토리! 밸런스 있는 빌드!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayResource: 0,
          homeArmy: 1,
          altText: '{home} 선수, 질럿이 달려갑니다! 마린이 부족할 때!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          text: '{home} 선수, 질럿이 마린을 밀어내면서 진입합니다!',
          owner: LogOwner.home,
          homeResource: 0,
          awayResource: 0,
          awayArmy: -1,
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayArmy: 3,
          awayResource: -5,
          altText: '{away} 선수, 마린이 벙커로! 화력이 집중됩니다!',
        ),
        ScriptEvent(
          text: '{home} 선수, 질럿을 추가합니다! 전진 건물에서 바로 합류!',
          owner: LogOwner.home,
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 2,
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: -25,
              altText: '{away} 선수, 벙커 건설 실패! 질럿에게 SCV를 잡혀냅니다!',
            ),
            ScriptEvent(
              text: '{home} 선수, 질럿이 팩토리까지 공격합니다!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
              awayArmy: -3,
            ...
            ScriptEvent(
              ...
              awayArmy: -15,
              decisive: true,
              altText: '{home} 선수, 전진 질럿! 테란 복합 편성이 구성되기도 전에 끝!',
            ),
          ],
        ),
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayResource: 0,
              awayArmy: 4,
              altText: '{away} 선수, 벙커에 마린 가득! 상대 병력이 접근 못 합니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              text: '{away} 선수, 벌처와 탱크가 나옵니다! 복합 편성이 갖춰지고 있어요!',
              owner: LogOwner.away,
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 6,
            ...
            ScriptEvent(
              ...
              homeArmy: -15,
              decisive: true,
              altText: '{away} 선수, 복합 편성의 화력! 프로토스를 압도합니다!',
            ),
          ],
        ),
      ],
