    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -15,
          altText: '{away} 선수, 배럭 가스! 수비형 빌드를 준비합니다!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -20,
          altText: '{home} 선수, 아둔! 다크 테크 루트입니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -20,
          altText: '{home} 선수, 템플러 아카이브가 올라갑니다!',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeArmy: 3,
          homeResource: -20,
          altText: '{home} 선수, 다크 2기! 수비형 테란에 잠입합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -10,
          altText: '{away} 선수, 엔지니어링 베이! 터렛으로 디텍이 가능합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          text: '{home} 선수, 다크 템플러가 테란 진영에 접근합니다!',
          owner: LogOwner.home,
          homeArmy: 0,
          awayArmy: 0,
          homeResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              altText: '{home} 선수, 다크가 터렛을 피해서 들어갑니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              text: '{home} 선수, 다크가 SCV를 줄줄이 베어냅니다! 엄청난 피해!',
              owner: LogOwner.home,
              homeArmy: 0,
              awayArmy: 0,
              homeResource: 0,
            ...
            ScriptEvent(
              ...
              awayArmy: -15,
              decisive: true,
              altText: '{home} 선수, 다크 잠입 대성공! 수비형 테란을 무너뜨렸습니다!',
            ),
          ],
        ),
        // 분기 B: 디텍 성공 → 탱크 방어 → 역전
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              altText: '{away} 선수, 터렛이 다크를 포착합니다! 완벽한 디텍!',
            ),
            ScriptEvent(
              text: '{away} 선수, 마린이 다크를 집중 사격! 격파합니다!',
              owner: LogOwner.away,
              awayArmy: 0,
              homeResource: 0,
              awayResource: 0,
            ...
            ScriptEvent(
              ...
              awayArmy: 6,
              awayResource: -15,
              altText: '{away} 선수, 탱크 시즈! 프로토스를 밀어냅니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeArmy: -15,
              decisive: true,
              altText: '{away} 선수, 디텍 성공 후 탱크 역전! 다크를 완벽히 막아냈습니다!',
            ),
          ],
        ),
      ],
