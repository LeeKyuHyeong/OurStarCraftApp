    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -15,
          altText: '{away} 선수, 배럭에 이어 팩토리를 올립니다. 시즈탱크를 노리는 빌드죠.',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -20,
          altText: '{home} 선수, 사이버네틱스 코어와 로보틱스, 서포트 베이를 연달아 올립니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeArmy: 3,
          homeResource: -15,
          altText: '{home} 선수, 리버 셔틀 출격! 테란 앞마당으로 향합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -20,
          altText: '{home} 선수, 스카랩 명중! 테란 일꾼에 큰 피해를 줍니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -25,
          altText: '{home} 선수, 스타게이트가 2개 올라갑니다! 공중 전력으로 전환합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          awayArmy: 2,
          awayResource: -15,
          altText: '{away} 선수, 골리앗을 생산합니다! 캐리어를 의식한 대응이죠.',
          skipChance: 0.2,
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeArmy: 4,
              awayArmy: -3,
              altText: '{home} 선수, 캐리어 편대가 시즈탱크 라인을 완전히 무시합니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: -15,
              decisive: true,
              altText: '{home} 선수, 캐리어 인터셉터가 쏟아집니다! 테란은 속수무책!',
            ),
          ],
        ),
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeArmy: -2,
              homeResource: -20,
              altText: '{away} 선수, 시즈탱크 포격! 프로토스 확장을 압박합니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeArmy: -15,
              decisive: true,
              altText: '{away} 선수, 탱크 푸시 성공! 프로토스를 캐리어 전환 전에 끝냅니다!',
            ),
          ],
        ),
      ],
