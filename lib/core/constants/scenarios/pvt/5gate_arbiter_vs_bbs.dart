    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: 2,          altText: '{away}, 마린 편대가 입구에 도착! 교전 시작입니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          homeArmy: 3, awayArmy: -3,          altText: '{home}, 드라군이 나왔습니다! 마린 상대로 효과적이죠!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 4,              altText: '{home}, 아비터가 나왔습니다! 리콜 준비 완료!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: 5,              altText: '{away}, 아비터 전에 승부를 걸어야 합니다! 전군 돌격!',
            ),
            ScriptEvent(
