    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -15,
          altText: '{away} 선수, 배럭 2개가 올라갑니다! 공격적인 빌드입니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{away} 선수, 마린을 끌고 나갑니다! 일꾼까지 동원한 올인!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{home} 선수, 질럿과 프로브 동원! 필사적인 수비입니다!',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: 2,          altText: '{away} 선수, 마린 편대가 입구에 도착! 교전 시작입니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          homeArmy: 3, awayArmy: -3,          altText: '{home} 선수, 드라군이 나왔습니다! 마린 상대로 효과적이죠!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -20,
          altText: '{home} 선수, 수비 성공! 이제 게이트웨이를 늘립니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          altText: '{home} 선수, 게이트웨이 다섯 개 체제! 템플러 아카이브도 건설!',
        ),
        ScriptEvent(
          ...
          altText: '{away} 선수, 시즈 탱크가 나옵니다! 방어 태세입니다.',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -25,
          altText: '{home} 선수, 스타게이트에 아비터 트리뷰널! 아비터를 노리는군요!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 4,              altText: '{home} 선수, 아비터가 나왔습니다! 리콜 준비 완료!',
            ),
            ScriptEvent(
              text: '{home} 선수, 리콜! 테란 본진에 드라군 질럿이 떨어집니다!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
              awayResource: -25, awayArmy: -5,              altText: '{home} 선수 리콜 투하! 테란 본진이 아수라장!',
            ),
            ScriptEvent(
              text: '{home} 선수, 하이 템플러 스톰까지! 상대 병력이 녹아내립니다!',
              owner: LogOwner.home,
              homeResource: 0,
              awayResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: 5,              altText: '{away} 선수, 아비터 전에 승부를 걸어야 합니다! 전군 돌격!',
            ),
            ScriptEvent(
              text: '{away} 선수, 시즈 탱크 포격이 프로토스 방어선을 뚫습니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayResource: 0,
              homeArmy: -6, awayArmy: -2,              altText: '{away} 선수 탱크 시즈 모드! 프로토스 건물이 무너집니다!',
            ),
            ScriptEvent(
