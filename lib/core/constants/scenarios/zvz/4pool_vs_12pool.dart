        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              owner: LogOwner.home,
              homeResource: 0,
              homeArmy: 1, awayResource: -20, awayArmy: -3,              altText: '{home}, 저글링 돌파! 드론을 초토화합니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              homeArmy: 2, awayResource: -10,              altText: '{home}, 저글링이 계속 들어갑니다! 초반 압박이 끝나지 않습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4, awayArmy: -1,              altText: '{away}, 드론 물량! 저글링을 잡아냅니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 5, awayResource: -10,              altText: '{away}, 풀 완성! 저글링과 발업으로 반격에 나섭니다!',
            ),
            ScriptEvent(
