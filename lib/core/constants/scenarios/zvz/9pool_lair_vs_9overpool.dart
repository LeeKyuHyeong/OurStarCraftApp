...
const _zvz9poolLairVs9overpool = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          owner: LogOwner.home,
          homeResource: -15,
          altText: '{home}, 9풀 레어! 스포닝풀과 가스를 동시에!',
        ),
        ScriptEvent(
          text: '{away} 선수 9드론에 오버로드를 먼저 올립니다! 풀은 그 다음!',
          owner: LogOwner.away,
          awayResource: -5,
          altText: '{away}, 9오버풀! 인구를 먼저 확보하고 풀 진입!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{away}, 저글링이 나옵니다! 9풀보다 한 박자 늦지만 드론이 1기 많습니다!',
        ),
        ScriptEvent(
          text: '9풀 레어 대 9오버풀! 빠른 테크 대 드론 안정!',
          owner: LogOwner.system,
          skipChance: 0.3,
          altText: '9풀 레어는 테크가 빠르고, 9오버풀은 드론이 안정적입니다!',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          text: '{home} 선수 저글링이 도착합니다! 9오버풀도 저글링이 나와있습니다!',
          owner: LogOwner.home,
          favorsStat: 'attack',
        ...
        ScriptEvent(
          text: '9풀 레어는 가스 드론을 유지해서 저글링 보충이 살짝 느립니다!',
          owner: LogOwner.system,
          skipChance: 0.3,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{away}, 드론 합세로 저글링을 잡습니다! 깔끔한 수비!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              altText: '{home}, 뮤탈로 드론 견제! 확장 타이밍을 정확히 노렸습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              altText: '{away}, 라바 이점이 폭발합니다! 저글링 물량이 밀려옵니다!',
            ),
            ScriptEvent(
              text: '스파이어 완성 전에 저글링 물량으로 밀어붙입니다! 라바 차이!',
              owner: LogOwner.away,
              decisive: true,
              altText: '스파이어 전에 저글링으로 결착! 9오버풀의 라바 이점 승리!',
            ),
          ],
        ),
        // 분기 C: 양쪽 확장 → 뮤탈전
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              owner: LogOwner.system,
              skipChance: 0.3,
              altText: '둘 다 앞마당! 9풀 레어의 테크가 먼저 완성될까요?',
            ),
          ],
        ),
      ],
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              altText: '{home}, 스커지를 피하면서 드론을 잡습니다! 뮤탈 컨트롤!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              owner: LogOwner.away,
              homeArmy: -3, awayArmy: 5, awayResource: -20, favorsStat: 'control',
            ...
            ScriptEvent(
              ...
              owner: LogOwner.away,
              decisive: true,
              altText: '뮤탈 타이밍을 뒤집었습니다! 9오버풀의 드론 우위 승리!',
            ),
          ],
        ),
      ],
