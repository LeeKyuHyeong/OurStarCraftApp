    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -250,
          altText: '{home} 선수, 9드론에 스포닝풀과 가스를 동시에! 빠른 레어를 노리나봅니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{home} 선수, 저글링과 레어 진화! 가스 드론은 계속 가스를 캡니다!',
        ),
        ScriptEvent(
          ...
          altText: '{away} 선수, 저글링이 나옵니다! 상대보다 한 박자 늦지만 드론이 1기 많습니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayResource: 0,
          awayArmy: 2,
          altText: '{away} 선수, 저글링이 준비되어 있습니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              altText: '{away} 선수, 드론 손실이 있지만 게임은 계속됩니다!',
            ),
          ],
        ),
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3, awayArmy: -1,              altText: '{away} 선수, 드론 합세로 저글링을 잡습니다! 깔끔한 수비!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              altText: '{home} 선수, 저글링 손실! 레어 진화에 집중해야 합니다!',
            ),
          ],
        ),
      ],
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayResource: 0,
              homeResource: 0,
              altText: '{home} 선수, 레어 완성! 바로 테크를 올립니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: -300,
              altText: '{away} 선수, 앞마당 해처리! 하지만 상대 테크가 먼저 올라올 시점!',
            ),
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              homeArmy: 4, awayResource: -100,              altText: '{home} 선수, 뮤탈로 드론 견제! 확장 타이밍을 정확히 노렸습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              awayResource: 0,
              homeResource: 0,
              altText: '{home} 선수, 가스 드론 유지로 미네랄이 부족합니다! 테크가 늦어요!',
            ),
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 4, awayResource: -200,              altText: '{away} 선수, 라바 이점이 폭발합니다! 저글링 물량이 밀려옵니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: -300,
              homeExpansion: true,
              altText: '{home} 선수, 레어 챙기고 확장! 테크를 준비합니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayResource: -300,
              awayExpansion: true,
              altText: '{away} 선수, 앞마당 해처리! 경기가 중반으로 넘어갑니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{home} 선수, 뮤탈 등장! 레어 빌드의 타이밍 이점!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: -100,
              altText: '{away} 선수, 스커지로 뮤탈을 잡으려 하지만 수가 부족합니다!',
            ),
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayResource: -100, awayArmy: -2,              altText: '{home} 선수, 스커지를 피하면서 드론을 잡습니다! 뮤탈 컨트롤!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayResource: 0,
              homeArmy: 4, homeResource: -400,
              altText: '{home} 선수, 뮤탈이 먼저지만 스커지에 피해를 입습니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              owner: LogOwner.away,
              homeResource: 0,
              homeArmy: -3, awayArmy: 4, awayResource: -500,              altText: '{away} 선수, 스커지 적중! 뮤탈도 나오면서 물량 역전!',
            ),
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -100,              altText: '{away} 선수, 뮤탈 물량에서 앞섭니다! 드론 견제가 누적됩니다!',
            ),
            ScriptEvent(
