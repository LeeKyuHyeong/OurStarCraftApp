...
// 9풀 미러 (공격적 미러 - 단일 빌드)
// ----------------------------------------------------------
const _zvz9poolMirrorSingle = ScenarioScript(
  id: 'zvz_9pool_mirror_single',
  matchup: 'ZvZ',
  homeBuildIds: ['zvz_9pool'],
  awayBuildIds: ['zvz_9pool'],
  description: '9풀 미러 저글링 대결',
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          text: '양측 저글링이 맞붙습니다! 9풀 미러의 핵심 교전!',
