...
const _zvz9poolLairVs12pool = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          altText: '{home} 선수, 저글링과 레어 진화! 가스 드론은 계속 유지합니다!',
        ),
        ScriptEvent(
          ...
          altText: '{away} 선수, 저글링이 나옵니다! 드론이 3기 많습니다!',
        ),
        ScriptEvent(
    ...
    // Phase 1: 저글링 도착 — 12풀은 이미 저글링 보유 (lines 8-12)
    ScriptPhase(
      name: 'ling_arrives',
      linearEvents: [
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              owner: LogOwner.home,
              homeResource: 0,
              homeArmy: -2, awayArmy: -1, awayResource: -100,              altText: '{home} 선수, 저글링 컨트롤! 상대 드론을 몇 기 잡습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3, awayArmy: -1,              altText: '{away} 선수, 드론 합세! 물량으로 저글링을 잡습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              altText: '{home} 선수, 스파이어를 올립니다! 레어 빌드의 테크 이점!',
            ),
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              homeArmy: 4, awayResource: -100,              altText: '{home} 선수, 뮤탈로 드론 견제! 상대는 뮤탈이 한참 멀었습니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: -300,
              altText: '{away} 선수, 스파이어를 올리지만 뮤탈이 먼저 왔습니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: -150,
              altText: '{away} 선수, 뮤탈 견제를 막을 수 없습니다! 드론이 녹고 있어요!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: -300,
              altText: '{away} 선수, 확장에 들어갑니다! 드론이 많아서 안정적입니다!',
            ),
            ScriptEvent(
              ...
              awayResource: 0,
              homeResource: 0,
              altText: '{home} 선수, 가스 투자가 크다 보니 미네랄이 부족합니다!',
            ),
            ScriptEvent(
              text: '{away} 선수 저글링 물량으로 밀어붙입니다! 드론 우위가 차이를 만듭니다!',
              owner: LogOwner.away,
              homeResource: 0,
              awayArmy: 5, homeArmy: -3, awayResource: -250,              altText: '{away} 선수, 드론과 라바 우위! 저글링 물량이 다릅니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              awayResource: -300,
              awayExpansion: true,
              altText: '{away} 선수, 드론 우위를 살려서 확장! 중반전으로 갑니다!',
            ),
            ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          altText: '{away} 선수, 스파이어를 올립니다! 공중 전환을 서두릅니다!',
        ),
      ],
    ),
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{home} 선수, 라바에서 뮤탈리스크가 나옵니다! 레어 빌드의 타이밍 이점!',
            ),
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -100,              altText: '{home} 선수, 뮤탈 견제! 상대 스파이어가 완성되기 전에!',
            ),
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayResource: -100, awayArmy: -2,              altText: '{home} 선수, 스커지를 피하면서 드론을 잡습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -100,              altText: '{away} 선수, 자원 우위가 빛납니다! 뮤탈 보충이 빠릅니다!',
            ),
            ScriptEvent(
