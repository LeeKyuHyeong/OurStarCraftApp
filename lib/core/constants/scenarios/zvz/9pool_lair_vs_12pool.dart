    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          owner: LogOwner.away,
          awayResource: -15,
          altText: '{away}, 12드론까지 모은 후 스포닝풀! 드론이 3기 더 많은 상태에서 풀 진입!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          text: '{away} 선수 스포닝풀이 완성됩니다! 저글링 생산 시작합니다!',
          owner: LogOwner.away,
          awayArmy: 4, awayResource: -10,
          altText: '{away}, 저글링이 나옵니다! 드론이 3기 많습니다!',
        ),
        ScriptEvent(
          text: '빠른 테크를 노리는 쪽 대 드론 우위를 가진 쪽! 어느 쪽이 유리할까요?',
          owner: LogOwner.system,
          skipChance: 0.3,
          altText: '테크가 빠른 쪽과 드론이 많은 쪽의 대결입니다!',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          owner: LogOwner.home,
          favorsStat: 'attack',
          altText: '{home}, 저글링 도착! 하지만 상대 저글링이 수비하고 있습니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          text: '가스 드론을 유지하고 있어서 저글링 보충이 느립니다!',
          owner: LogOwner.system,
          skipChance: 0.3,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{home}, 저글링 컨트롤! 상대 드론을 몇 기 잡습니다!',
            ),
            ScriptEvent(
              text: '{away} 선수 드론이 빠졌지만 아직 드론 우위가 남아있습니다!',
              owner: LogOwner.away,
              altText: '{away}, 드론 손실이 있지만 드론 우위는 건재합니다!',
            ),
          ],
        ),
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{away}, 드론 합세! 물량으로 저글링을 잡습니다!',
            ),
            ScriptEvent(
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              text: '{home} 선수 뮤탈리스크 등장! 상대는 아직 스파이어가 멀었습니다!',
              owner: LogOwner.home,
              homeArmy: 5, awayResource: -15, favorsStat: 'harass',
              altText: '{home}, 뮤탈로 드론 견제! 상대는 뮤탈이 한참 멀었습니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              text: '뮤탈 타이밍 차이가 결정적! 빠른 뮤탈이 승부를 갈랐습니다!',
              owner: LogOwner.home,
              decisive: true,
              altText: '빠른 뮤탈의 위력! 상대가 뮤탈 전에 무너집니다!',
            ),
          ],
        ),
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              owner: LogOwner.away,
              awayResource: -20,
              altText: '{away}, 확장에 들어갑니다! 드론이 많아서 안정적입니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              altText: '{away}, 드론과 라바 우위! 저글링 물량이 다릅니다!',
            ),
            ScriptEvent(
              text: '테크가 완성되기 전에 저글링 물량으로 결착! 드론 우위의 승리!',
              owner: LogOwner.away,
              decisive: true,
              altText: '드론 우위를 유지하면서 저글링 물량으로 밀어붙입니다!',
            ),
          ],
        ),
        // 분기 C: 양쪽 확장 → 뮤탈전
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              awayResource: -20,
              awayExpansion: true,
              altText: '{away}, 드론 우위를 살려서 확장! 중반전으로 갑니다!',
            ),
            ScriptEvent(
      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              text: '{home} 선수 뮤탈로 드론을 견제합니다! 상대는 아직 스파이어가 멀었습니다!',
              owner: LogOwner.home,
            ...
            ScriptEvent(
              ...
              owner: LogOwner.home,
              decisive: true,
              altText: '빠른 레어의 뮤탈 타이밍! 상대가 뮤탈 전에 무너집니다!',
            ),
          ],
        ),
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              altText: '{away}, 자원 우위가 빛납니다! 뮤탈 보충이 빠릅니다!',
            ),
            ScriptEvent(
              text: '드론 우위로 뮤탈 물량을 역전! 자원 우위가 빛을 발합니다!',
              owner: LogOwner.away,
              decisive: true,
              altText: '뮤탈 타이밍을 뒤집었습니다! 자원 우위의 승리!',
            ),
          ],
        ),
      ],
