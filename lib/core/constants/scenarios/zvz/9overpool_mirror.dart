    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -300,
          altText: '{home} 선수, 9드론에 오버로드를 먼저 올리고 스포닝풀을 짓습니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -300,
          altText: '{away} 선수, 역시 오버로드 후 스포닝풀! 드론 수가 같습니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 1, homeResource: -50,          altText: '{home} 선수, 저글링을 뭉칩니다! 앞마당을 시도할까요?',
        ),
        ScriptEvent(
          ...
          homeArmy: 0,
          homeResource: 0,
          awayArmy: 1, awayResource: -50,          altText: '{away} 선수, 앞마당 타이밍을 노립니다! 저글링 견제가 두렵습니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -300,
          altText: '{home} 선수, 앞마당 건설! 저글링으로 입구를 막으면서 시간을 법니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -300,
          altText: '{away} 선수, 앞마당! 양쪽 다 저글링 수비하면서 확장에 들어갑니다!',
        ),
      ],
    ),
    // Phase 2: 저글링 견제 - 분기
    ScriptPhase(
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home} 선수, 저글링으로 상대 앞마당 드론을 노립니다! 성큰 완성 전!',
              owner: LogOwner.home,
              homeArmy: 0,
              homeResource: 0,
              awayResource: -100, awayArmy: -2,              altText: '{home} 선수 저글링 견제! 앞마당 드론을 물어뜯습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away} 선수, 저글링으로 상대 앞마당 드론을 노립니다! 성큰 완성 전!',
              owner: LogOwner.away,
              awayArmy: 0,
              awayResource: 0,
              homeResource: -100, homeArmy: -2,              altText: '{away} 선수 저글링 견제! 앞마당 드론을 물어뜯습니다!',
            ),
            ScriptEvent(
