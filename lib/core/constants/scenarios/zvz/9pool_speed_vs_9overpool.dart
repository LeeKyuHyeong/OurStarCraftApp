    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          altText: '{away}, 저글링이 나오기 시작합니다! 9풀보다 한 박자 늦지만 드론이 1기 더 많습니다!',
        ),
        ScriptEvent(
          text: '9풀 발업 대 9오버풀! 풀 타이밍 한 박자 차이가 발업 타이밍까지 이어집니다!',
          owner: LogOwner.system,
          skipChance: 0.3,
          altText: '9풀이 먼저 저글링을 뽑았지만 9오버풀도 곧 저글링이 나옵니다!',
        ),
      ],
    ),
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              text: '9오버풀이 확장 수비 성공! 라바 이점으로 결착합니다!',
              owner: LogOwner.away,
              decisive: true,
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              owner: LogOwner.home,
              decisive: true,
              altText: '뮤탈 물량에서 앞서면서 드론 차이를 벌립니다! 9풀 발업의 승리!',
            ),
          ],
        ),
        // 분기: 어웨이(9오버풀) 뮤탈 우위
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              owner: LogOwner.away,
              decisive: true,
              altText: '라바 차이로 뮤탈 보충이 빠른 9오버풀! 물량 차이로 결착!',
            ),
          ],
        ),
      ],
