...
const _zvz9poolSpeedVs9overpool = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          altText: '{away} 선수, 9드론에 오버로드 후 스포닝풀! 인구를 먼저 확보하고 풀 진입!',
        ),
        ScriptEvent(
          ...
          altText: '{home} 선수, 저글링에 발업! 가스 드론은 미네랄로 복귀!',
        ),
        ScriptEvent(
          ...
          altText: '{away} 선수, 저글링이 나오기 시작합니다! 상대보다 한 박자 늦지만 드론이 1기 더 많습니다!',
        ),
        ScriptEvent(
    ...
    // Phase 1: 저글링 도착 — 9오버풀 이미 저글링 보유 (lines 10-14)
    ScriptPhase(
      name: 'ling_arrives',
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          altText: '{home} 선수, 저글링 도착! 하지만 상대 저글링과 마주칩니다!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          awayArmy: 2,
          altText: '{away} 선수, 저글링이 준비되어 있습니다! 드론 우위도 살짝 있습니다!',
        ),
        ScriptEvent(
    ...
    // Phase 2: 초반 저글링 교전 — 비등/홈 피해/어웨이 피해 (lines 15-19)
    ScriptPhase(
      name: 'ling_skirmish',
      branches: [
        // 분기: 비등한 교전
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              altText: '{away} 선수, 드론 손실이 있지만 아직 괜찮습니다!',
            ),
          ],
        ),
        // 분기: 9오버풀 쪽이 수비 잘 함
    ...
    // Phase 3: 확장 분기 — 9오버풀 확장 + 9풀 발업 반응 (lines 20-24)
    ScriptPhase(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: -300,
              altText: '{away} 선수, 앞마당 해처리를 건설합니다! 경기를 길게 가져가려 합니다!',
            ),
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeArmy: 4, homeResource: -200,              altText: '{home} 선수, 발업 저글링 추가 투입! 해처리 건설 중에 들어갑니다!',
            ),
            ScriptEvent(
              ...
              altText: '{away} 선수, 확장에 자원을 쓴 타이밍에 압박이 들어옵니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 3, awayResource: -450,
              altText: '{away} 선수, 확장과 수비를 동시에! 드론 우위가 빛납니다!',
            ),
            ScriptEvent(
              ...
              altText: '{home} 선수, 압박을 넣지만 상대 저글링이 충분합니다!',
            ),
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 3, awayResource: -150,              altText: '{away} 선수, 해처리 2개의 라바 이점! 저글링 물량이 밀려옵니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: -300,
              altText: '{away} 선수, 앞마당 해처리 건설! 경기를 길게 가져가려 합니다!',
            ),
            ScriptEvent(
              ...
              homeResource: -300,
              homeExpansion: true,
              altText: '{home} 선수, 압박 대신 해처리! 경기가 중반으로 넘어갑니다!',
            ),
            ScriptEvent(
    ...
    // Phase 4: 레어 → 스파이어 → 뮤탈전 (lines 28-35)
    ScriptPhase(
      name: 'mutal_war',
      branches: [
        // 분기: 홈(9풀 발업) 뮤탈 우위
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayResource: 0,
              homeResource: -250,
              altText: '{home} 선수, 레어 진화 시작! 뮤탈 타이밍을 노립니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: -250,
              altText: '{away} 선수, 레어 진화! 테크 타이밍 싸움입니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayResource: -150, awayArmy: -2,              altText: '{home} 선수, 뮤탈 컨트롤이 좋습니다! 상대 스커지를 피하면서 드론을 잡습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: -250,
              altText: '{away} 선수, 레어 진화! 해처리 2개의 라바로 드론과 유닛을 동시에!',
            ),
            ScriptEvent(
              ...
              awayResource: 0,
              homeResource: -250,
              altText: '{home} 선수, 레어 진화! 테크 타이밍을 놓치면 안 됩니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -150, homeArmy: -2,              altText: '{away} 선수, 뮤탈 컨트롤! 상대 뮤탈을 스커지로 잡으면서 드론도 견제!',
            ),
            ScriptEvent(
