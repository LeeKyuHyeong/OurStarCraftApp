    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -20,
          altText: '{away}, 9드론에 스포닝풀과 가스를 동시에! 빠른 테크를 노리나봅니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          altText: '{home}, 저글링 도착! 상대도 저글링이 있습니다!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          awayArmy: 1,
          altText: '{away}, 빠른 스포닝풀을 확인하고 가스 드론을 미네랄로 전환! 저글링 보충에 집중!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              owner: LogOwner.home,
              homeResource: 0,
              awayResource: -15, awayArmy: -3, homeArmy: -3,              altText: '{home}, 저글링 서라운드! 수비 저글링을 잡으면서 드론까지!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              homeArmy: 2, awayResource: -10,              altText: '{home}, 초반 러시의 끈질긴 압박! 드론 차이를 좁혔습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3, awayArmy: -2,              altText: '{away}, 저글링과 드론으로 협공! 상대 저글링을 잡아냅니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 3, awayResource: -10,              altText: '{away}, 초반 러시를 완벽하게 막았습니다! 레어 진화가 곧 완료됩니다!',
            ),
            ScriptEvent(
