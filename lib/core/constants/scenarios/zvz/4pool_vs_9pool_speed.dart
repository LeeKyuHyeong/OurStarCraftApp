    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -15,
          altText: '{home}, 4드론에 스포닝풀을 올립니다! 극단적인 올인이에요!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -20,
          altText: '{away}, 9드론에 스포닝풀과 가스를 동시에 올립니다! 저글링 속업을 노리나봅니다!',
        ),
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 6, homeResource: -8,          altText: '{home}, 극초반 첫 저글링이 달려갑니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          altText: '{home}, 저글링 도착! 그런데 상대 저글링이 벌써 수비하고 있습니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              owner: LogOwner.home,
              homeResource: 0,
              awayResource: -15, awayArmy: -2, homeArmy: -2,              altText: '{home}, 저글링으로 드론을 물어뜯습니다! 수비 저글링을 피해서!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              homeArmy: 2, awayResource: -10,              altText: '{home}, 저글링을 계속 보냅니다! 4기뿐인 드론에서 쥐어짜냅니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3, awayArmy: -2,              altText: '{away}, 저글링과 드론 협공! 상대 저글링을 잡아냅니다!',
            ),
            ScriptEvent(
              ...
              awayResource: 0,
              homeArmy: -2,
              altText: '{home}, 초반 저글링이 밀립니다! 라바가 부족합니다!',
            ),
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 4, awayResource: -10,              altText: '{away}, 발업 저글링의 속도 차이! 상대 저글링을 압도합니다!',
            ),
            ScriptEvent(
