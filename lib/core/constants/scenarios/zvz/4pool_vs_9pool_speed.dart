    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayArmy: 0,
          awayResource: 0,
          homeArmy: 3, homeResource: -150,          altText: '{home} 선수, 극초반 첫 저글링이 달려갑니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              owner: LogOwner.home,
              homeResource: 0,
              awayResource: -150, awayArmy: -2, homeArmy: -2,              altText: '{home} 선수, 저글링으로 드론을 물어뜯습니다! 수비 저글링을 피해서!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: -100,
              homeArmy: 2, awayResource: -100,              altText: '{home} 선수, 저글링을 계속 보냅니다! 4기뿐인 드론에서 쥐어짜냅니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 4, awayResource: -200,              altText: '{away} 선수, 발업 저글링의 속도 차이! 상대 저글링을 압도합니다!',
            ),
            ScriptEvent(
