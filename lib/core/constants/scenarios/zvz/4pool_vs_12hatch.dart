    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -15,
          altText: '{home}, 4드론에 스포닝풀을 올립니다! 정말 빠르네요!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -5,
          altText: '{away}, 드론에 집중! 앞마당 해처리를 올리려 합니다!',
        ),
        ScriptEvent(
          ...
          altText: '{home}, 저글링이 달려갑니다! 앞마당부터 올린 상대에게 최악의 타이밍!',
        ),
        ScriptEvent(
          ...
          altText: '{away}, 앞마당 해처리를 건설 중! 스포닝풀이 아직 없습니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              owner: LogOwner.home,
              homeResource: 0,
              homeArmy: 4, awayResource: -15, awayArmy: -8,              altText: '{home}, 저글링이 드론과 앞마당을 동시에 파괴합니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4, awayArmy: -1,              altText: '{away}, 드론 컨트롤! 저글링을 하나씩 잡아냅니다!',
            ),
            ScriptEvent(
              ...
              awayResource: 0,
              homeArmy: -3,
              altText: '{home}, 초반 저글링이 밀립니다! 드론 물량을 못 이깁니다!',
            ),
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 10, awayResource: -10,              altText: '{away}, 풀 완성! 저글링이 나오면서 반격에 나섭니다!',
            ),
            ScriptEvent(
