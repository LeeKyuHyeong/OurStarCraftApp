...
const _zvz12hatchVs12pool = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          owner: LogOwner.away,
          awayResource: -15,
          altText: '{away}, 12풀! 저글링으로 앞마당을 압박할 수 있습니다.',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{away}, 저글링에 발업! 12앞마당보다 30초 먼저 저글링이 나옵니다.',
        ),
        ScriptEvent(
          text: '12앞마당 대 12풀! 저글링 타이밍이 30초 차이 납니다.',
          owner: LogOwner.system,
          skipChance: 0.3,
          altText: '12풀 저글링이 먼저 나옵니다! 12앞마당의 풀은 아직 건설 중!',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          text: '{away} 선수 저글링이 상대 앞마당에 도착합니다! 12앞마당의 풀은 아직 건설 중입니다!',
          owner: LogOwner.away,
        ...
        ScriptEvent(
          text: '12풀 저글링이 먼저 도착했습니다! 12앞마당은 드론으로 버텨야 합니다!',
          owner: LogOwner.system,
          skipChance: 0.3,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '드론 대 저글링! 12앞마당은 드론이 많아서 버팁니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{home}, 드론 물량으로 저글링을 잡습니다! 12앞이라 드론이 많습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{away}, 발업 저글링! 12앞마당의 해처리를 노립니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              text: '발업 저글링 압박에 앞마당이 무너집니다! 12풀 압박이 성공!',
              owner: LogOwner.away,
              decisive: true,
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              owner: LogOwner.away,
              awayArmy: -2,
              altText: '{away}, 압박 실패! 12앞마당이 해처리 이점을 가져갑니다.',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              owner: LogOwner.home,
              decisive: true,
              altText: '앞마당을 지켜낸 12앞! 해처리 2개의 라바가 결정적!',
            ),
          ],
        ),
        // 분기 C: 양쪽 확장 → 뮤탈전
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              owner: LogOwner.home,
              homeResource: -15,
              altText: '{home}, 레어 진화! 12앞의 라바 이점으로 드론과 유닛 동시 생산!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              owner: LogOwner.away,
              decisive: true,
              altText: '뮤탈 컨트롤이 물량 차이를 극복합니다! 12풀의 승리!',
            ),
          ],
        ),
      ],
