    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: 2,          altText: '{away}, 저글링 도착! 상대 저글링이 없습니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeArmy: 0,
              awayResource: 0,
              homeResource: -15, awayArmy: -1,              altText: '{away}, 저글링 돌파! 드론이 녹고 있습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeArmy: 0,
              awayResource: 0,
              awayArmy: -2, homeResource: -5,              altText: '{home}, 드론 물량으로 저글링을 잡습니다! 앞마당부터 올려서 드론이 많습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 4, awayResource: -10,              altText: '{away}, 발업 저글링! 상대 앞마당 해처리를 노립니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -10,              altText: '{away}, 드론 견제 성공! 앞마당 해처리가 무너지고 있습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 4, awayArmy: -3,              altText: '{home}, 저글링 합류! 드론과 저글링으로 압박을 막습니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeArmy: 4, homeResource: -10,              altText: '{home}, 라바 이점이 폭발합니다! 해처리 2개의 힘!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayResource: -15, awayArmy: -2,              altText: '{home}, 뮤탈 물량이 앞섭니다! 드론 견제가 누적됩니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -15, homeArmy: -2,              altText: '{away}, 뮤탈 컨트롤이 좋습니다! 스커지를 피하면서 드론을 잡습니다!',
            ),
            ScriptEvent(
