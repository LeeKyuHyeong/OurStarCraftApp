    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: 2,          altText: '{away} 선수, 저글링 도착! 상대 저글링이 없습니다!',
        ),
        ScriptEvent(
          ...
          awayResource: 0,
          homeArmy: 5,
          altText: '{home} 선수, 풀이 건설 중! 드론으로 버텨야 합니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeArmy: 3,
              skipChance: 0.3,
              altText: '{home} 선수, 풀 완성! 이제 저글링으로 수비할 수 있습니다!',
            ),
          ],
        ),
        // 분기: 12풀이 드론을 많이 잡음
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              altText: '{away} 선수, 저글링이 드론에 당하고 있습니다. 추가 저글링을 보내야 합니다.',
              skipChance: 0.3,
            ),
          ],
        ),
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 4, awayArmy: -3,              altText: '{home} 선수, 저글링 합류! 드론과 저글링으로 압박을 막습니다!',
            ),
            ScriptEvent(
              ...
              awayResource: 0,
              awayArmy: -2,
              altText: '{away} 선수, 압박 실패! 앞마당 해처리가 살아남으면서 이점을 가져갑니다.',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{home} 선수, 저글링 합류로 수비! 앞마당이 살아있습니다.',
            ),
            ScriptEvent(
