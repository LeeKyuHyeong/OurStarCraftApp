    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -15,
          altText: '{home} 선수, 9드론에 스포닝풀과 가스까지! 저글링 속업을 노리나봅니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -15,
          altText: '{away} 선수, 똑같이 9드론에 스포닝풀과 속업! 라바 분배 싸움입니다!',
        ),
        ScriptEvent(
          text: '{home} 선수, 저글링 6기 생산! 발업이 끝나면 바로 압박하겠다는 의도!',
          owner: LogOwner.home,
          awayArmy: 0,
          awayResource: 0,
        ...
        ScriptEvent(
          text: '{away} 선수, 저글링 6기! 양쪽 다 발업을 기다리면서 저글링을 모읍니다!',
          owner: LogOwner.away,
          homeArmy: 0,
          homeResource: 0,
        ...
        ScriptEvent(
          text: '{home} 선수, 라바가 나올 때마다 저글링을 추가합니다! 눈치 싸움!',
          owner: LogOwner.home,
          awayArmy: 0,
          awayResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -3, homeArmy: -1,              altText: '{home} 선수 저글링 컨트롤! 효율적으로 잡아냅니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 4, awayArmy: -2,              altText: '{home} 선수 라바를 저글링에! 물량으로 밀어붙입니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3, awayArmy: -1,              altText: '{away} 선수 저글링 컨트롤! 효율적으로 잡아냅니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: 4, homeArmy: -2,              altText: '{away} 선수 라바를 저글링에! 물량으로 밀어붙입니다!',
            ),
            ScriptEvent(
              text: '첫 교전의 저글링 수 차이가 결정적! 수비 붕괴!',
              owner: LogOwner.away,
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              homeArmy: 2, awayResource: -10,              altText: '{home} 선수, 양쪽 전선을 동시에 관리합니다! 컨트롤의 차이!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeArmy: 0,
              awayResource: 0,
              awayArmy: 2, homeResource: -10,              altText: '{away} 선수, 양쪽 전선을 동시에 관리합니다! 컨트롤의 차이!',
            ),
            ScriptEvent(
              text: '멀티태스킹 차이가 승부를 갈랐습니다! 수비 붕괴!',
              owner: LogOwner.away,
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -8,              altText: '{home} 선수 뮤탈이 상대 드론을 물어뜯습니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -5,              altText: '{away} 선수, 뮤탈로 역습! 드론을 끊으면서 자원 차이를 줄입니다!',
            ),
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              homeArmy: 2, awayResource: -8,              altText: '{home} 선수 뮤탈 추가 생산! 드론을 또 잡습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -8,              altText: '{away} 선수 뮤탈이 상대 드론을 물어뜯습니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -5,              altText: '{home} 선수, 뮤탈로 역습! 드론을 끊으면서 자원 차이를 줄입니다!',
            ),
            ScriptEvent(
              ...
              homeArmy: 0,
              awayResource: 0,
              awayArmy: 2, homeResource: -8,              altText: '{away} 선수 뮤탈 추가 생산! 드론을 또 잡습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -4,              altText: '{home} 선수 스커지가 뮤탈 뭉치를 관통! 대박입니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4,              altText: '{away} 선수 스커지가 뮤탈 뭉치를 관통! 대박입니다!',
            ),
            ScriptEvent(
              text: '한 번의 스커지 컨트롤로 뮤탈 수가 크게 벌어졌습니다!',
              owner: LogOwner.system,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -4,              altText: '{home} 선수 저글링 돌진! 6기 차이가 보입니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -5, awayArmy: -3,              altText: '{away} 선수 드론까지 동원! 입구에서 저글링을 잡아냅니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 4, awayResource: -10,              altText: '{away} 선수 뮤탈 선점! 드론을 하나씩 끊습니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3, awayArmy: 2,              altText: '{away} 선수 스커지가 해처리 앞에서 대기! 뮤탈이 모이질 못합니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4,              altText: '{away} 선수 저글링 돌진! 6기 차이가 보입니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -5, homeArmy: -3,              altText: '{home} 선수 드론까지 동원! 입구에서 저글링을 잡아냅니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeArmy: 4, homeResource: -10,              altText: '{home} 선수 뮤탈 선점! 드론을 하나씩 끊습니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -3, homeArmy: 2,              altText: '{home} 선수 스커지가 해처리 앞에서 대기! 뮤탈이 모이질 못합니다!',
            ),
            ScriptEvent(
              text: '수비 성공에서 뮤탈 선점, 스커지 저격까지! 완벽한 역전!',
              owner: LogOwner.home,
