  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          owner: LogOwner.away,
          awayResource: -30,
          altText: '{away}, 12앞마당! 확장을 가져가겠다는 빌드!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          text: '9오버풀 vs 12앞마당! 앞마당을 지킬 수 있을까요?',
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          text: '{home}, 뮤탈리스크가 먼저 나옵니다! 드론을 노립니다!',
          owner: LogOwner.home,
          homeArmy: 3, homeResource: -20,
          altText: '{home} 선수 뮤탈 선점! 견제 시작!',
        ),
        ScriptEvent(
