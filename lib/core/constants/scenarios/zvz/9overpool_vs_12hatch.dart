    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          altText: '{home}, 저글링이 나옵니다! 앞마당부터 올린 상대보다 먼저!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              homeArmy: -1, awayResource: -10,              altText: '{home}, 저글링 컨트롤! 드론 피해를 줍니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -2,              altText: '{away}, 드론과 저글링 합세! 상대 저글링을 잡아냅니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              altText: '{home}, 상대 드론 물량이 수비에서 빛났습니다.',
              skipChance: 0.3,
            ),
          ],
        ),
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeArmy: 4, homeResource: -10,              altText: '{home}, 발업 저글링 추가 투입! 앞마당을 노립니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -10,              altText: '{home}, 드론 견제 성공! 앞마당 해처리까지 위험합니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: 4, homeArmy: -3,              altText: '{away}, 수비 성공! 해처리 2개라 저글링 보충이 빠릅니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 4, awayResource: -10,              altText: '{away}, 라바 이점이 폭발합니다! 물량 차이가 벌어집니다!',
            ),
            ScriptEvent(
