...
const _zvz9overpoolVs12hatch = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayResource: 0,
          homeResource: -250,
          altText: '{home} 선수, 스포닝풀과 가스를 올립니다.',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -200,
          altText: '{away} 선수, 해처리 후 스포닝풀! 저글링이 한참 뒤에 나옵니다.',
        ),
        ScriptEvent(
          ...
          altText: '{home} 선수, 저글링이 나옵니다! 앞마당부터 올린 상대보다 먼저!',
        ),
        ScriptEvent(
          text: '저글링 타이밍이 관건입니다! 스포닝풀이 빠른 쪽이 유리한 타이밍이에요.',
          ...
          awayResource: 0,
          skipChance: 0.3,
          altText: '앞마당부터 올린 쪽은 풀이 아직 건설 중입니다. 저글링 도착 타이밍이 중요합니다.',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          text: '{home} 선수 저글링이 상대 앞마당에 도착합니다! 상대 풀이 막 완성되는 시점입니다!',
          owner: LogOwner.home,
          homeArmy: 0,
          awayArmy: 0,
          homeResource: 0,
          awayResource: 0,
          altText: '{home} 선수, 저글링 도착! 상대 저글링이 막 나오려는 타이밍!',
        ),
        ScriptEvent(
          ...
          awayResource: -150,
          awayArmy: 3,
          altText: '{away} 선수, 풀 완성! 저글링이 나오기 시작합니다!',
        ),
        ScriptEvent(
          text: '상대 저글링이 막 나오기 시작합니다! 드론으로 조금만 버티면 됩니다!',
          owner: LogOwner.system,
          homeArmy: 0,
          awayArmy: 0,
          homeResource: 0,
          awayResource: 0,
          skipChance: 0.3,
          altText: '양쪽 저글링이 거의 동시에 만납니다!',
        ),
      ],
    ),
    // Phase 2: 저글링 교전 (lines 13-17)
    ScriptPhase(
      name: 'ling_skirmish',
      branches: [
        // 분기: 비등한 교전
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              owner: LogOwner.system,
              homeResource: 0,
              homeArmy: -1, awayArmy: -1, awayResource: -50,
              altText: '저글링 대 저글링! 상대 저글링이 막 합류했습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              homeArmy: -1, awayResource: -100,              altText: '{home} 선수, 저글링 컨트롤! 드론 피해를 줍니다!',
            ),
            ScriptEvent(
              ...
              awayResource: 0,
              awayArmy: -1,
              altText: '{away} 선수, 저글링 합류! 뒤늦게 막지만 드론이 빠졌습니다.',
            ),
          ],
        ),
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away} 선수 드론과 저글링을 뭉쳐서 수비합니다! 상대 저글링이 밀립니다!',
              owner: LogOwner.away,
              awayArmy: 0,
              homeResource: 0,
              awayResource: 0,
              homeArmy: -2,              altText: '{away} 선수, 드론과 저글링 합세! 상대 저글링을 잡아냅니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              altText: '{home} 선수, 상대 드론 물량이 수비에서 빛났습니다.',
              skipChance: 0.3,
            ),
          ],
        ),
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeArmy: 4, homeResource: -400,              altText: '{home} 선수, 발업 저글링 추가 투입! 앞마당을 노립니다!',
            ),
            ScriptEvent(
              ...
              altText: '{away} 선수, 발업 저글링 속도를 따라잡지 못 합니다!',
            ),
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -100,              altText: '{home} 선수, 드론 견제 성공! 앞마당 해처리까지 위험합니다!',
            ),
            ScriptEvent(
              text: '발업 저글링 압박에 앞마당이 무너집니다! 타이밍이 적중했습니다!',
              owner: LogOwner.home,
              homeArmy: 0,
              awayArmy: 0,
              homeResource: 0,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              owner: LogOwner.away,
              homeResource: 0,
              awayArmy: 4, homeArmy: -3, awayResource: -200,              altText: '{away} 선수, 수비 성공! 해처리 2개라 저글링 보충이 빠릅니다!',
            ),
            ScriptEvent(
              ...
              awayResource: 0,
              homeResource: -300,
              altText: '{home} 선수, 압박 실패! 확장도 늦어서 불리합니다.',
            ),
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 4, awayResource: -200,              altText: '{away} 선수, 라바 이점이 폭발합니다! 물량 차이가 벌어집니다!',
            ),
            ScriptEvent(
              ...
              awayResource: 0,
              decisive: true,
              altText: '드론과 저글링으로 버텨냈습니다! 해처리 2개가 빛을 발합니다!',
            ),
          ],
        ),
        // 분기 C: 양쪽 확장 → 뮤탈전
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              owner: LogOwner.away,
              homeResource: 0,
              awayArmy: 3, homeArmy: -2, awayResource: -150,
              altText: '{away} 선수, 저글링 합류로 수비 성공! 확장 이점을 유지합니다.',
            ),
            ScriptEvent(
              ...
              homeResource: -300,
              homeExpansion: true,
              altText: '{home} 선수, 압박이 안 됩니다! 확장으로 전환!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: -250,
              altText: '{away} 선수, 레어 진화! 라바가 많아 테크도 빠르게!',
            ),
            ScriptEvent(
