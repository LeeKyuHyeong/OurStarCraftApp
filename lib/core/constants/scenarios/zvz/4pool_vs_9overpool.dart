    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -5,
          altText: '{away}, 9드론에 오버로드를 먼저 올리고 스포닝풀로 이어갑니다!',
        ),
        ScriptEvent(
          ...
          altText: '{home}, 저글링 출발! 오버로드 먼저 올린 상대에게 타이밍이 좋습니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -15,
          altText: '{away}, 오버로드를 먼저 올렸기 때문에 스포닝풀이 더 늦어요!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          altText: '{home}, 저글링 도착! 오버로드를 먼저 올려서 풀이 더 늦어요!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              owner: LogOwner.home,
              homeResource: 0,
              homeArmy: 1, awayResource: -20, awayArmy: -3,              altText: '{home}, 저글링 돌파! 드론이 녹고 있습니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              homeArmy: 2, awayResource: -10,              altText: '{home}, 저글링이 계속 들어갑니다! 남은 드론까지 추격!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3, awayArmy: -1,              altText: '{away}, 드론 컨트롤! 저글링을 하나씩 잡습니다!',
            ),
            ScriptEvent(
              ...
              awayResource: 0,
              homeArmy: -2,
              altText: '{home}, 초반 저글링이 밀립니다! 드론 물량에 막히고 있어요!',
            ),
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 5, awayResource: -10,              altText: '{away}, 풀 완성! 저글링으로 반격합니다!',
            ),
            ScriptEvent(
