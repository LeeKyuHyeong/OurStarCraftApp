    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          homeArmy: 2,          altText: '{home}, 발업 쪽은 가스 드론이 미네랄로 복귀해서 저글링 추가가 빠릅니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3, awayArmy: -1,              altText: '{away}, 드론 합세로 발업 저글링을 잡습니다! 깔끔한 수비!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeArmy: 4, homeResource: -10,              altText: '{home}, 발업 저글링 추가 투입! 레어 완성 전에 끝내려 합니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -10,              altText: '{home}, 드론이 너무 많이 빠졌습니다! 스파이어까지 갈 수 없습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3, awayArmy: -1,              altText: '{away}, 수비 성공! 레어 진화가 완료됩니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayResource: -15, awayArmy: -2,              altText: '{home}, 뮤탈 컨트롤이 결정적! 스커지를 피하면서 드론을 잡습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -20,              altText: '{away}, 뮤탈 견제! 발업 쪽은 스파이어가 아직 멀었습니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: 3, homeArmy: -2,              altText: '{away}, 뮤탈 물량에서 압도! 스커지도 정확히 적중합니다!',
            ),
            ScriptEvent(
