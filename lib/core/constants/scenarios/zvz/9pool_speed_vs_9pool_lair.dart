...
const _zvz9poolSpeedVs9poolLair = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: -50,
          altText: '{away} 선수, 역시 9드론에 스포닝풀과 가스를 동시에! 레어를 노리는 빌드!',
        ),
        ScriptEvent(
          ...
          altText: '{home} 선수, 저글링에 발업! 가스 드론을 미네랄로 돌립니다!',
        ),
        ScriptEvent(
          ...
          altText: '{away} 선수, 저글링은 같은 수! 하지만 가스는 레어에 투자합니다!',
        ),
        ScriptEvent(
    ...
    // Phase 1: 저글링 교전 시작 — 수는 같지만 미네랄 차이 (lines 9-13)
    ScriptPhase(
      name: 'ling_clash',
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: -100,
          awayResource: 0,
          homeArmy: 2,          altText: '{home} 선수, 발업 쪽은 가스 드론이 미네랄로 복귀해서 저글링 추가가 빠릅니다!',
        ),
        ScriptEvent(
          ...
          awayResource: -50,
          awayArmy: 1,
          altText: '{away} 선수, 레어 진화를 위해 가스 드론을 유지합니다! 저글링 보충은 살짝 느립니다!',
        ),
        ScriptEvent(
    ...
    // Phase 2: 초반 저글링 교전 결과 (lines 14-18)
    ScriptPhase(
      name: 'ling_skirmish',
      branches: [
        ScriptBranch(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              owner: LogOwner.home,
              homeResource: 0,
              homeArmy: -2, awayArmy: -1, awayResource: -100,              altText: '{home} 선수, 저글링 컨트롤! 드론을 몇 기 잡아냅니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              altText: '{away} 선수, 드론 손실이 있지만 레어 완성이 다가옵니다!',
            ),
          ],
        ),
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3, awayArmy: -1,              altText: '{away} 선수, 드론 합세로 발업 저글링을 잡습니다! 깔끔한 수비!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              altText: '{home} 선수, 저글링 손실이 있지만 발업 완료가 다가옵니다!',
            ),
          ],
        ),
      ],
    ),
    // Phase 3: 발업 완료 — 압박 vs 테크 (lines 19-23)
    ScriptPhase(
      name: 'speed_vs_tech',
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeArmy: 4, homeResource: -200,              altText: '{home} 선수, 발업 저글링 추가 투입! 레어 완성 전에 끝내려 합니다!',
            ),
            ScriptEvent(
              ...
              altText: '{away} 선수, 노발업 저글링으로는 발업 저글링을 못 잡습니다!',
            ),
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -100,              altText: '{home} 선수, 드론이 너무 많이 빠졌습니다! 스파이어까지 갈 수 없습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{home} 선수, 발업 저글링으로 압박! 하지만 상대 수비가 좋습니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3, awayArmy: -1,              altText: '{away} 선수, 수비 성공! 레어 진화가 완료됩니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayArmy: 2, awayResource: -100,
              altText: '{away} 선수, 레어 완성! 발업 쪽보다 테크가 훨씬 빠릅니다!',
            ),
            ScriptEvent(
              ...
              altText: '{away} 선수, 스파이어 건설! 뮤탈리스크 생산이 시작됩니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: -300,
              homeExpansion: true,
              altText: '{home} 선수, 발업은 챙기고 확장으로! 경기가 길어집니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: -50,
              altText: '{away} 선수, 레어 진화 중! 테크 우위를 노립니다!',
            ),
            ScriptEvent(
    ...
    // Phase 3.5: 스파이어 건설 (startLine 24)
    ScriptPhase(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{away} 선수, 레어 완성! 레어 빌드의 진가가 드러납니다!',
            ),
            ScriptEvent(
              text: '{away} 선수 스파이어를 올립니다! 뮤탈이 먼저 나옵니다!',
              owner: LogOwner.away,
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 4, awayResource: -700,
              altText: '{away} 선수, 스파이어 완성! 뮤탈리스크 생산 시작!',
            ),
            ScriptEvent(
              ...
              homeResource: -50,
              skipChance: 0.7,
              altText: '{home} 선수, 스포어로 본진과 앞마당을 수비합니다!',
            ),
            ScriptEvent(
              ...
              awayResource: 0,
              homeResource: -250,
              altText: '{home} 선수, 뒤늦게 레어! 테크 격차를 좁혀야 합니다!',
            ),
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeArmy: 4, homeResource: -700,
              altText: '{home} 선수, 뮤탈 등장! 상대 스커지를 피하면서 드론을 노립니다!',
            ),
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayResource: -150, awayArmy: -2,              altText: '{home} 선수, 뮤탈 컨트롤이 결정적! 스커지를 피하면서 드론을 잡습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayArmy: 0, awayResource: 0,
              altText: '{away} 선수, 레어 완성! 상대는 아직 레어가 멀었습니다!',
            ),
            ScriptEvent(
              text: '{away} 선수 스파이어를 올립니다! 뮤탈이 먼저 나옵니다!',
              owner: LogOwner.away,
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -150,              altText: '{away} 선수, 뮤탈 견제! 발업 쪽은 스파이어가 아직 멀었습니다!',
            ),
            ScriptEvent(
              ...
              awayResource: 0,
              homeResource: -300,
              altText: '{home} 선수, 뒤늦게 스파이어! 하지만 드론 손실이 너무 큽니다!',
            ),
            ScriptEvent(
              ...
              homeResource: -200,
              awayResource: -300,
              awayArmy: 3, homeArmy: -2,              altText: '{away} 선수, 뮤탈 물량에서 압도! 스커지도 정확히 적중합니다!',
            ),
            ScriptEvent(
