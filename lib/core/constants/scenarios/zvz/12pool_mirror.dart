...
const _zvz12poolMirror = ScenarioScript(
  ...
  phases: [
    ...
    // Phase 1: 앞마당 확장 타이밍 - 분기 (lines 17-28)
    ScriptPhase(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              altText: '{home}, 저글링으로 입구를 막으면서 시간을 법니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              altText: '{away}, 저글링으로 입구를 막으면서 시간을 법니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              owner: LogOwner.home,
              awayArmy: -5, awayResource: -20, homeArmy: -3, favorsStat: 'attack',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              owner: LogOwner.away,
              homeArmy: -5, homeResource: -20, awayArmy: -3, favorsStat: 'attack',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{home}, 저글링으로 상대 앞마당 드론을 노립니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{away}, 저글링으로 상대 앞마당 드론을 노립니다!',
            ),
            ScriptEvent(
