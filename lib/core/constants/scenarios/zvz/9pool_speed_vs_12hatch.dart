...
const _zvz9poolSpeedVs12hatch = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          altText: '{home}, 저글링에 발업! 12앞마당을 노릴 수 있는 타이밍!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          text: '9풀 발업 대 12앞마당! 풀 완성 시점이 거의 동시입니다!',
    ...
    // Phase 2: 초반 교전 결과 — 드론 수비 (lines 17-22)
    ScriptPhase(
      name: 'initial_fight',
      startLine: 17,
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              text: '비등한 교환! 12앞마당은 드론 피해가 있지만 저글링도 나오기 시작합니다!',
              owner: LogOwner.system,
              skipChance: 0.3,
            ),
          ],
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{home}, 발업 저글링 추가 투입! 12앞마당을 못 살리겠다는 판단!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              altText: '{home}, 드론이 계속 빠집니다! 12앞마당이 무너지고 있습니다!',
            ),
            ScriptEvent(
              text: '발업 저글링 압박 성공! 12앞마당의 드론이 부족합니다!',
              owner: LogOwner.home,
              decisive: true,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{away}, 저글링 합류! 드론과 저글링으로 발업 압박을 막습니다!',
            ),
            ScriptEvent(
              text: '{home} 선수 압박이 막히고 있습니다! 12앞마당의 라바가 돌기 시작합니다!',
              owner: LogOwner.home,
              homeArmy: -2,
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              owner: LogOwner.home,
              decisive: true,
              altText: '뮤탈 컨트롤로 라바 이점을 극복합니다! 9풀 발업의 승리!',
            ),
          ],
        ),
        ScriptBranch(
