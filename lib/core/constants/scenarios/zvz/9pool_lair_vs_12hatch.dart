        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              owner: LogOwner.away,
              homeResource: 0,
              homeArmy: -2, awayArmy: -1, awayResource: -100,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              homeArmy: -1, awayResource: -150,              altText: '{home} 선수, 저글링 돌파! 드론이 녹고 있습니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: -50,
              altText: '{away} 선수, 저글링 나오기 전에 드론이 많이 빠졌습니다!',
            ),
          ],
        ),
        ScriptBranch(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeArmy: 3, homeResource: -150,              altText: '{home} 선수, 저글링 추가 투입! 레어는 곧 완성됩니다!',
            ),
            ScriptEvent(
              ...
              altText: '{away} 선수, 저글링이 나왔지만 드론 손실이 큽니다!',
            ),
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: 0,              altText: '{home} 선수, 레어 완성! 압박을 이어갑니다!',
            ),
            ScriptEvent(
              ...
              altText: '{home} 선수, 스파이어를 올립니다! 공중 유닛이 곧 나옵니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: 4, homeArmy: -3,              altText: '{away} 선수, 저글링 합류! 드론과 저글링으로 압박을 막습니다!',
            ),
            ScriptEvent(
              ...
              awayResource: 0,
              homeArmy: -2,
              altText: '{home} 선수, 압박 실패! 가스에 투자한 만큼 저글링이 부족합니다!',
            ),
            ScriptEvent(
              ...
              homeArmy: 0,
              homeResource: 0,
              awayArmy: 4, awayResource: -200,              altText: '{away} 선수, 라바 이점이 폭발합니다! 저글링 물량이 다릅니다!',
            ),
            ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          altText: '{home} 선수, 스파이어 완성! 공중 유닛 생산을 시작합니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          altText: '{away} 선수, 스파이어를 올립니다! 대공 준비에 들어갑니다!',
        ),
      ],
    ),
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{home} 선수, 뮤탈 등장! 상대는 대공 유닛이 전혀 없어요!',
            ),
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -200,              altText: '{home} 선수, 상대에게 대공이 없습니다! 뮤탈이 마음껏 견제합니다!',
            ),
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: -100,
              altText: '{away} 선수, 스커지로 대응하려 하지만 뮤탈이 너무 많습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayResource: 0,
              homeArmy: 4, homeResource: -400,
              altText: '{home} 선수, 뮤탈이 나왔는데 스커지에 당합니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: -300,
              homeArmy: -3, awayArmy: 4,              altText: '{away} 선수, 스커지 적중! 뮤탈이 녹는 사이 저글링으로 반격!',
            ),
            ScriptEvent(
              ...
              homeArmy: 0,
              awayResource: -200,
              awayArmy: 4, homeResource: -150,              altText: '{away} 선수, 뮤탈 잡고 저글링 돌진! 라바 이점으로 물량이 밀려옵니다!',
            ),
            ScriptEvent(
