      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              text: '{home} 선수 마린이 녹고 있습니다! 벌처를 못 뚫어요!',
              owner: LogOwner.home,
              homeArmy: -2,
            ),
            ScriptEvent(
              text: '{away}, 추가 팩토리 가동! 탱크 벌처가 쏟아집니다!',
              owner: LogOwner.away,
    ...
    ScriptPhase(
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away}, 5팩 물량! 탱크 벌처가 압도적입니다!',
              owner: LogOwner.away,
              awayArmy: 4, favorsStat: 'macro',
              altText: '{away} 선수 물량 차이! 5팩의 힘!',
            ),
            ScriptEvent(
