...
// 5팩 타이밍 vs CC퍼스트
// ----------------------------------------------------------
const _tvt5facVs1barDouble = ScenarioScript(
  id: 'tvt_5fac_vs_cc_first',
  matchup: 'TvT',
  homeBuildIds: ['tvt_5fac'],
  awayBuildIds: ['tvt_1bar_double'],
  description: '5팩 타이밍 vs CC퍼스트 공수 대결',
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          fixedCost: true,
          altText: '{away} 선수 CC퍼스트에서 팩토리까지 안정적으로 올립니다.',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          owner: LogOwner.away,
          awayResource: -300, // 시즈모드(300) - 머신샵은 위에서 이미
          fixedCost: true,
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          text: '5팩 타이밍 vs CC퍼스트 수비. 공수 대결의 시작.',
      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              text: '{home} 선수 5팩 물량으로 수비 라인을 돌파합니다!',
              owner: LogOwner.home,
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              owner: LogOwner.away,
              awayResource: -150, // 아머리(150) - 이미 위에서 올렸을 수도 있지만 분기
              fixedCost: true,
            ),
            ScriptEvent(
              text: '{away} 선수 CC퍼스트 자원 우위. 탱크 골리앗이 쌓입니다.',
              owner: LogOwner.away,
            ...
            ScriptEvent(
              text: '{away} 선수 마인과 더블 자원으로 5팩 타이밍을 버텨냅니다!',
              owner: LogOwner.away,
