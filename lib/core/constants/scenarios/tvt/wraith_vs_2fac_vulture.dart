...
// 레이스 클로킹 vs 투팩 벌처
// ----------------------------------------------------------
const _tvtWraithVs2facVulture = ScenarioScript(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          altText: '{away}, 투팩 벌처 물량! 지상을 장악합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          altText: '{home}, 레이스가 나옵니다! 투스타포트!',
        ),
        ScriptEvent(
          text: '투스타 레이스 vs 투팩 벌처! 공중과 지상의 대결!',
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              text: '레이스 견제가 막혔습니다! 투팩 벌처가 지상을 장악합니다!',
              owner: LogOwner.system,
            ),
          ],
        ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          altText: '{away}, 투팩 물량! 탱크 라인이 두껍습니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away}, 투팩 물량이 풀가동! 탱크 벌처가 압도적입니다!',
              owner: LogOwner.away,
            ...
            ScriptEvent(
              text: '{away} 선수 투팩 골리앗과 터렛으로 레이스를 격추! 지상전 승리!',
              owner: LogOwner.away,
              decisive: true,
