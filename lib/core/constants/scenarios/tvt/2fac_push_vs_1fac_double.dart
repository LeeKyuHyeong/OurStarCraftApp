        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -15,              altText: '{home} 선수 벌처 우회 침투! SCV를 잡아냅니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayResource: -5,              altText: '{home} 선수 벌처 추가, 견제가 이어집니다.',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -15,              altText: '{home} 선수 탱크 드랍! SCV 피해가 발생합니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -20,              altText: '{home} 선수 드랍십 두 대! 세 방향 공격!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: 4,              altText: '{away} 선수 자원 우위. 병력이 빠르게 늘어납니다.',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -2, awayArmy: -1,              altText: '{away} 선수 물량 공세! 상대 라인이 무너집니다!',
            ),
            ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: -5, homeArmy: -5,          altText: '{home} 선수 탱크 화력! 상대 병력이 무너집니다!',
        ),
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          homeArmy: -5, awayArmy: -5,          altText: '{away} 선수 골리앗 집중 화력! 맞섭니다!',
        ),
        // ── 맵 특성 이벤트 ──
