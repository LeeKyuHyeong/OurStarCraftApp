    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayArmy: 0,
          homeResource: 0,
          awayResource: -10,          altText: '{away} 선수 SCV 수리! 벙커를 지켜야 합니다!',
        ),
        ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -3,              altText: '{home} 선수 시즈 포격! 벙커가 버티지 못합니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -20,              altText: '{home} 선수 SCV까지 잡아냅니다! 일꾼 피해!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -15,              altText: '{away} 선수 드랍 견제 성공! 피해를 주고 빠집니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: 5, homeArmy: -3,              altText: '{away} 선수 물량 공세! 더블 자원의 힘!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -3,              altText: '{home} 선수 정면 탱크 포격! 상대 라인을 찢습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -20, homeArmy: -2,              altText: '{away} 선수 올인 드랍! 생산 시설을 파괴합니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -3,              altText: '{home} 선수 초반 시즈 피해! 상대가 따라잡지 못합니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: 5, homeArmy: -3,              altText: '{away} 선수 자원 우위! 탱크 골리앗 대군!',
            ),
            ScriptEvent(
