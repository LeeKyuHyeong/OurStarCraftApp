...
const _tvtFdRushVs1fac1star = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          fixedCost: true,
          altText: '{home}, 팩토리에 머신샵! 빠른 시즈를 노립니다!',
        ),
        ScriptEvent(
          ...
          fixedCost: true,
          altText: '{away}, 팩토리와 스타포트! 원팩원스타 체제!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          fixedCost: true,
          altText: '{away}, 벌처와 레이스! 기동력을 가져갑니다!',
        ),
      ],
    ),
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          text: '{home}, 시즈 모드 연구 시작! 탱크가 진가를 발휘할 준비!',
          owner: LogOwner.home,
        ...
        ScriptEvent(
          ...
          owner: LogOwner.away,
          favorsStat: 'scout',
          altText: '{away}, 벌처 정찰! 상대가 탱크를 빨리 뽑고 있습니다!',
        ),
        ScriptEvent(
          text: '{away}, 레이스가 나왔습니다! 상대 본진을 정찰합니다!',
          owner: LogOwner.away,
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              text: '{away}, 레이스로 추가 견제! 상대 일꾼을 괴롭힙니다!',
              owner: LogOwner.away,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home}, 탱크 시즈! 접근하는 벌처를 포격합니다!',
              owner: LogOwner.home,
            ...
            ScriptEvent(
              text: '{home}, 탱크 라인을 전진시킵니다! 시즈 거리 제기!',
              owner: LogOwner.home,
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          fixedCost: true,
          altText: '{home}, 앞마당 확장! 탱크 라인이 보호합니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          fixedCost: true,
          altText: '{home}, 탱크가 계속 나옵니다! 더블 팩토리의 힘!',
        ),
        ScriptEvent(
          text: '{away}, 드랍십에 탱크를 싣고 뒤를 노립니다!',
          owner: LogOwner.away,
        ...
        ScriptEvent(
          text: '드랍 견제 vs 정면 탱크 라인! 긴장감이 높아집니다!',
          owner: LogOwner.system,
          skipChance: 0.25,
        ),
      ],
    ...
    ScriptPhase(
      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home}, 탱크 물량이 압도적입니다! 정면 시즈 포격!',
              owner: LogOwner.home,
