        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -15,              altText: '{away} 선수 벌처 우회! SCV를 노립니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -10,              altText: '{away} 선수 레이스 견제! 다방면에서 압박!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              awayArmy: -3,              altText: '{home} 선수 시즈 포격! 벌처가 녹습니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 2, awayArmy: -4,              altText: '{home} 선수 탱크 라인! 상대 진영을 포격합니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -15, homeArmy: -2,              altText: '{away} 선수 다방면 견제! 상대가 흔들립니다!',
            ),
            ScriptEvent(
