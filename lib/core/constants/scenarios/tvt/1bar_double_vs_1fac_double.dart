    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayArmy: 0,
          homeResource: 0,
          awayResource: -100,          altText: '{home} 선수 벌처 기동! 일꾼을 노립니다!',
          skipChance: 0.3,
        ),
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -150,              altText: '{home} 선수 벌처 컨트롤! 상대 앞마당 SCV 피해!',
            ),
            // SCV 추가 피해 (전투)
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -4,              altText: '{away} 선수 수비 성공! 벌처 견제를 무력화!',
            ),
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              homeResource: 0,
              awayResource: -150,              altText: '{home} 선수 벌처 견제! 상대 일꾼을 공격!',
            ),
            // 벌처 대응으로 병력 분산 (전투)
            ScriptEvent(
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 2, awayArmy: -4,              altText: '{home} 선수 정면 전진! 상대 라인을 밀어붙입니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeResource: -200, homeArmy: -4,              altText: '{away} 선수 탱크 드랍! 상대 후방이 위험합니다!',
            ),
            ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          awayArmy: -8, homeArmy: -6,          altText: '{home} 선수 탱크 화력 집중! 상대 병력이 녹습니다!',
        ),
        // 전투: 반격
        ScriptEvent(
          ...
          homeResource: 0,
          awayResource: 0,
          homeArmy: -8, awayArmy: -6,          altText: '{away} 선수 골리앗 화력으로 맞섭니다!',
        ),
        // ── 맵 특성 이벤트 ──
        // 근거리 맵: 시스템 해설
        ScriptEvent(
