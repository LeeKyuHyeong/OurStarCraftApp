...
// 레이스 클로킹 vs CC퍼스트
// ----------------------------------------------------------
const _tvtWraithVsCcFirst = ScenarioScript(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          altText: '{away}, 팩토리가 올라갑니다! CC퍼스트 운영!',
        ),
        ScriptEvent(
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              text: '{home}, 스캔에 걸리지만 아머리 짓는 SCV를 집요하게 노립니다! 골리앗을 막겠다는 의도!',
              owner: LogOwner.home,
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          altText: '{away}, 탱크 라인 구축! CC퍼스트 자원 가동!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away}, CC퍼스트 자원이 풀가동! 물량 차이가 벌어집니다!',
              owner: LogOwner.away,
