    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayResource: -500,
          fixedCost: true,
          altText: '{away} 선수도 투팩입니다. 속업 타이밍 싸움입니다.',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          text: '속업 타이밍과 컨트롤이 승부를 결정합니다. 컨트롤 싸움이 중요하겠습니다.',
          owner: LogOwner.system,
          skipChance: 0.2,
          altText: '확장 없이 벌처 싸움부터 가겠다는 거죠.',
        ),
        ScriptEvent(
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              owner: LogOwner.system,
              skipChance: 0.3,
              altText: '투팩에서 벌처전 열세는 곧바로 자원 열세로 이어집니다.',
            ),
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              text: '투팩 교착 상태입니다. 탱크 전환 타이밍이 관건입니다.',
              owner: LogOwner.system,
              skipChance: 0.5,
