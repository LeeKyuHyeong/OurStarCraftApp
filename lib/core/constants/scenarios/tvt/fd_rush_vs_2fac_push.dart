...
const _tvtFdRushVs2facPush = ScenarioScript(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          fixedCost: true,
          altText: '{away}, 팩토리 투팩! 벌처를 대량 생산할 준비!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          ...
          fixedCost: true,
          altText: '{away}, 벌처 속업! 투팩에서 벌처가 물 밀듯이!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          text: '{away}, 벌처 4기로 센터를 장악합니다! 마인 매설!',
          owner: LogOwner.away,
        ...
        ScriptEvent(
          ...
          fixedCost: true,
          favorsStat: 'strategy',
          altText: '{home}, 시즈 모드! 벌처 접근을 차단합니다!',
        ),
        ScriptEvent(
          text: '{away}, 벌처가 시즈 탱크를 우회하려 합니다!',
          owner: LogOwner.away,
          favorsStat: 'harass',
    ...
    ScriptPhase(
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home}, 시즈 탱크 포격! 벌처가 직격탄에 폭발합니다!',
              owner: LogOwner.home,
            ...
            ScriptEvent(
              text: '{home}, 탱크를 전진 배치합니다! 라인을 밀어갑니다!',
              owner: LogOwner.home,
              homeArmy: 2, homeResource: -250, // 탱크 1기 250
              fixedCost: true,
              favorsStat: 'attack',
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away}, 벌처가 마인을 피하며 옆길로 침투합니다!',
              owner: LogOwner.away,
            ...
            ScriptEvent(
              text: '{away}, 추가 벌처까지! 상대 일꾼을 쓸어갑니다!',
              owner: LogOwner.away,
              awayArmy: 4, awayResource: -150, // 벌처 2기 (75x2)
              fixedCost: true,
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ScriptEvent(
          ...
          fixedCost: true,
          altText: '{home}, 더블 팩토리에서 탱크가 쏟아집니다!',
        ),
        ScriptEvent(
        ...
        ScriptEvent(
          text: '{home}, FD 러쉬 준비 완료! 탱크 라인 전진!',
          owner: LogOwner.home,
          homeArmy: 2, homeResource: -250, // 탱크 1기 250
          fixedCost: true,
          favorsStat: 'attack',
    ...
    ScriptPhase(
      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{home}, 탱크 시즈 라인이 상대 앞마당까지 도달합니다!',
              owner: LogOwner.home,
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              text: '{away}, 벌처 견제가 누적됩니다! 상대 자원이 바닥!',
              owner: LogOwner.away,
