        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -20,              altText: '{away} 선수 SCV 공격! 상대 일꾼이 큰 피해!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -10,              altText: '{away} 선수 벌처 견제! SCV를 잡아내고 빠집니다.',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: 2, awayArmy: -3,              altText: '{home} 선수 탱크 시즈! 상대 병력을 녹입니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              awayArmy: 0,
              awayResource: 0,
              homeResource: -15,              altText: '{away} 선수 벌처 기습! 일꾼 피해가 큽니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              homeResource: 0,
              awayResource: 0,
              homeArmy: -3,              altText: '{away} 선수 올인 정면 공격! 탱크 라인에 돌진합니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeArmy: 0,
              awayResource: 0,
              awayArmy: 2, homeResource: -15,              altText: '{away} 선수 벌처 견제! 상대 후방을 기습!',
            ),
            ScriptEvent(
              text: '{home} 선수 후방 피해가 큽니다! 탱크 라인이 흔들립니다!',
              owner: LogOwner.home,
