...
// BBS 올인 러시 vs CC퍼스트
// ----------------------------------------------------------
const _tvtBbsVsCcFirst = ScenarioScript(
  id: 'tvt_bbs_vs_cc_first',
  matchup: 'TvT',
  homeBuildIds: ['tvt_bbs'],
  awayBuildIds: ['tvt_cc_first'],
  description: 'BBS 올인 러시 vs CC퍼스트',
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          owner: LogOwner.away,
          awayResource: -30,
          altText: '{away}, CC퍼스트! 배럭 없이 커맨드 먼저 짓습니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      branches: [
        ...
        // 분기 B: SCV로 마린 끊기 → BBS 방어 → CC퍼스트 반격 → 어웨이 승리
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              homeArmy: -3,
              favorsStat: 'defense',
              altText: '{away}, SCV 컨트롤! 벙커 짓는 SCV를 잡아냅니다!',
            ),
            ScriptEvent(
            ...
            ScriptEvent(
              text: '{away} 선수 가스 채취 시작! 팩토리 건설! 벌처가 나옵니다!',
              owner: LogOwner.away,
              awayArmy: 8,
              homeArmy: -5,
              awayResource: -15,
            ...
            ScriptEvent(
              text: 'CC퍼스트 자원과 빠른 테크! BBS 측이 따라잡을 수 없는 격차입니다!',
              owner: LogOwner.system,
              homeArmy: -5,
            ),
            ScriptEvent(
