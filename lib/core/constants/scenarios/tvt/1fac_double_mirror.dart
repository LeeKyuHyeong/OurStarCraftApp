...
const _tvt1facDoubleMirror = ScenarioScript(
  ...
  phases: [
    ...
    // Phase 1: 마인 수비 + 소규모 교전 (lines 14-23) - recovery 150/줄 (early-mid)
    ScriptPhase(
      name: 'mine_defense',
      startLine: 14,
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          owner: LogOwner.home,
          homeArmy: 2, homeResource: -75, // 벌처 추가 (75/2sup)
          fixedCost: true,
          favorsStat: 'scout',
    ...
    // Phase 2: 트리플 확장 경쟁 - 분기 (lines 24-37) - recovery 150/줄
    ScriptPhase(
      name: 'triple_race',
      startLine: 24,
      recoveryArmyPerLine: 1,
    ...
    // Phase 3: 탱크 골리앗 대량 생산 (lines 38-51) - recovery 200/줄 (mid-game)
    ScriptPhase(
      name: 'buildup',
      startLine: 38,
      ...
      linearEvents: [
        ScriptEvent(
          ...
          owner: LogOwner.home,
          homeArmy: 4, homeResource: -800, // 탱크x2(500) + 시즈모드 연구(300)
          fixedCost: true,
        ...
        ScriptEvent(
          ...
          owner: LogOwner.away,
          awayArmy: 4, awayResource: -800,
          fixedCost: true,
        ),
        ScriptEvent(
          text: '{home} 선수 아머리 건설! 공방 업그레이드를 시작합니다!',
          owner: LogOwner.home,
          homeResource: -350, // 아머리(150) + 공업Lv1(200)
          fixedCost: true,
    ...
    // Phase 4: 드랍 견제 - 분기 (lines 52-67) - recovery 200/줄
    ScriptPhase(
      name: 'drop_harass',
      startLine: 52,
      recoveryArmyPerLine: 2,
    ...
    // Phase 5: 결전 (lines 68-80) - recovery 200/줄
    ScriptPhase(
    ...
    // Phase 6: 결전 판정 - 분기 (lines 81+) - recovery 200/줄
    ScriptPhase(
