...
// BBS vs 원팩 푸시
// ----------------------------------------------------------
const _tvtBbsVs1facPush = ScenarioScript(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          owner: LogOwner.away,
          awayResource: -20,
          altText: '{away}, 팩토리가 올라갑니다! 벌처 탱크를 노립니다!',
        ),
        ScriptEvent(
      ...
      branches: [
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              text: '{away}, 탱크까지 생산! BBS를 완전히 막아냅니다!',
              owner: LogOwner.away,
              awayArmy: 2, homeArmy: -1,
              altText: '{away} 선수 탱크 합류! BBS를 완전히 차단합니다!',
            ),
            ScriptEvent(
        ...
        ScriptBranch(
          ...
          events: [
            ScriptEvent(
              ...
              altText: '{away} 선수 물량 차이! 원팩 푸시의 힘!',
            ),
            ScriptEvent(
