...
const _tvz2barAcademyVs4pool = ScenarioScript(
  id: 'tvz_2bar_academy_vs_4pool',
  matchup: 'TvZ',
  homeBuildIds: ['tvz_2bar_academy'],
  awayBuildIds: ['zvt_4pool'],
  description: '2배럭 아카데미 vs 4풀',
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          awayArmy: 2,
          fixedCost: true,
          altText: '{away} 선수 저글링 전부 돌진! 저글링을 계속 모으고 있습니다!',
        ),
        ScriptEvent(
          text: '4드론입니다! 저글링이 벌써 테란 본진에 도착했습니다!',
          owner: LogOwner.system,
          skipChance: 0.3,
          altText: '초반 러쉬! 마린 생산이 간당간당합니다!',
        ),
      ],
    ),
    // Phase 1: 4풀 러쉬 결과
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              ...
              favorsStat: 'attack',
              decisive: true,
              altText: '{away} 선수 본진 초토화! 초반 러쉬 성공!',
            ),
          ],
        ),
        ScriptBranch(
