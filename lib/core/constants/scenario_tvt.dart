  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          text: '{home} 선수 기술적 우위로 버팁니다! 벌처 마인+드랍 견제!',
          owner: LogOwner.home,
          awayArmy: -2, favorsStat: 'strategy+harass',
          skipChance: 0.3,
          altText: '{home}, 마인과 드랍! 상대 물량을 흩트립니다!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          ...
          owner: LogOwner.away,
          homeArmy: -10, awayArmy: -5, favorsStat: 'defense',
      ...
      branches: [
        ...
        ScriptBranch(
          ...
          events: [
            ...
            ScriptEvent(
              text: '{home} 선수 앞마당 SCV 피해! 벙커로 막아보지만 이미 피해가 큽니다!',
              owner: LogOwner.home,
              homeResource: -15,
            ),
            ScriptEvent(
  ...
  phases: [
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          text: '{away}, 벌처 6기로 맞대응! 마인을 피하면서 이동합니다!',
          owner: LogOwner.away,
          awayArmy: 4, awayResource: -15, favorsStat: 'control',
          altText: '{away} 선수 벌처 6기! 마인을 피해 기동!',
        ),
        ScriptEvent(
    ...
    ScriptPhase(
      ...
      linearEvents: [
        ...
        ScriptEvent(
          text: '{away} 선수도 탱크 전환! 시즈 모드 연구! 아머리도 건설합니다!',
          owner: LogOwner.away,
          awayArmy: 3, awayResource: -20,
        ),
        ScriptEvent(
          ...
          owner: LogOwner.home,
          homeResource: -20,
          altText: '{home}, 아머리가 올라갑니다!',
        ),
        ScriptEvent(
          text: '{away} 선수 골리앗 생산 시작! 탱크+골리앗 라인 형성!',
          owner: LogOwner.away,
          awayArmy: 3, awayResource: -20,
